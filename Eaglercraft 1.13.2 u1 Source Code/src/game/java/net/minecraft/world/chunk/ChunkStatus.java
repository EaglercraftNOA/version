...
public enum ChunkStatus implements ITaskType<ChunkPos, ChunkStatus> {
   ...
   private ChunkStatus(String nameIn, @Nullable ChunkTask taskIn, int taskRangeIn, boolean updateHeightmapsIn, ChunkStatus.Type typeIn) {
      this.name = nameIn;
      this.task = taskIn;
      this.taskRange = taskRangeIn;
      this.type = typeIn;
      this.updateHeightmaps = updateHeightmapsIn;
   }

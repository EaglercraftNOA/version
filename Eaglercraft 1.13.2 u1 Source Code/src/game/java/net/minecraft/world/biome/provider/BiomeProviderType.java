...
public class BiomeProviderType<C extends IBiomeProviderSettings, T extends BiomeProvider> {
   ...
   public static <C extends IBiomeProviderSettings, T extends BiomeProvider> BiomeProviderType<C, T> register(String p_212581_0_, Function<C, T> p_212581_1_, Supplier<C> p_212581_2_) {

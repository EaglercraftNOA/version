...
public class LakesFeature extends Feature<LakesConfig> {
   ...
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, LakesConfig p_212245_5_) {
      ...
      if (p_212245_4_.getY() <= 4) {
            ...
            for(int l2 = 0; l2 < 16; ++l2) {
               for(int k = 0; k < 8; ++k) {
                  ...
                  if (flag) {
                     ...
                     if (k < 4 && !material.isSolid() && p_212245_1_.getBlockState(p_212245_4_.add(k1, k, l2)).getBlock() != p_212245_5_.block) {
                        return false;
                     }
                  }
               }
            ...
            for(int i3 = 0; i3 < 16; ++i3) {
               for(int i4 = 0; i4 < 8; ++i4) {
                  if (aboolean[(l1 * 16 + i3) * 8 + i4]) {
                     p_212245_1_.setBlockState(p_212245_4_.add(l1, i4, i3), i4 >= 4 ? field_205188_a : p_212245_5_.block.getDefaultState(), 2);
                  }
               }
            }
         }
         ...
         if (p_212245_5_.block.getDefaultState().getMaterial() == Material.LAVA) {
         ...
         if (p_212245_5_.block.getDefaultState().getMaterial() == Material.WATER) {

...
public abstract class Structure<C extends IFeatureConfig> extends Feature<C> {
   ...
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, C p_212245_5_) {
         ...
         for(int k1 = j - i; k1 <= j + i; ++k1) {
            for(int l1 = k - i; l1 <= k + i; ++l1) {
               ...
               if (structurestart != NO_STRUCTURE && structurestart.getBoundingBox().intersectsWith(l, i1, l + 15, i1 + 15)) {
                  ...
                  p_212245_1_.getChunkProvider().getChunkOrPrimer(j, k, true).addStructureReference(this.getStructureName(), i2);

...
public class BlockBlobFeature extends Feature<BlockBlobConfig> {
   public boolean place(IWorld p_212245_1_, IChunkGenerator<? extends IChunkGenSettings> p_212245_2_, Random p_212245_3_, BlockPos p_212245_4_, BlockBlobConfig p_212245_5_) {
      while(true) {
         label50: {
            ...
            int i1 = p_212245_5_.startRadius;

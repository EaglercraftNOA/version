   ...
   public NBTTagCompound func_212181_a(NBTTagCompound p_212181_1_) {
      ...
      for(String s : this.func_208218_b()) {
         ...
         if (!nbttagcompound2.contains(s, 12) && structure != null) {
            ...
            nbttagcompound2.putLongArray(s, longlist);
         }
      }

      nbttagcompound1.put("References", nbttagcompound2);
      nbttagcompound.put("Structures", nbttagcompound1);
      p_212181_1_.put("Level", nbttagcompound);
      return p_212181_1_;
   }
         ...
         if (long2objectmap != null) {
            ...
            if (this.field_208224_f.get(field_208220_b.get(s)).func_208023_c(i)) {
               ...
               if (nbttagcompound3 != null) {
                  nbttagcompound2.put(s, nbttagcompound3);
               }
            }
         }
      }

      nbttagcompound1.put("Starts", nbttagcompound2);
      nbttagcompound.put("Structures", nbttagcompound1);
      p_212182_1_.put("Level", nbttagcompound);
      return p_212182_1_;
   }
         ...
         for(String s : this.func_208214_a()) {
            ...
            for(String s1 : nbttagcompound.keySet()) {
               ...
               if (!nbttaglist.isEmpty()) {
                  ...
                  if (s4 != null) {
                     nbttagcompound1.putString("id", s4);
                  }
               }
            ...
            String s5 = s + "_index";
            StructureIndexesSavedData structureindexessaveddata = p_212184_1_.get(DimensionType.OVERWORLD, StructureIndexesSavedData::new, s5);
            if (structureindexessaveddata != null && !structureindexessaveddata.getAll().isEmpty()) {
               ...
               p_212184_1_.set(DimensionType.OVERWORLD, s5, structureindexessaveddata1);

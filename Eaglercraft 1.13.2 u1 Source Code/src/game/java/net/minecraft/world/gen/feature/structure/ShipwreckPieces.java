...
public class ShipwreckPieces {
   ...
   public static class Piece extends TemplateStructurePiece {
      ...
      private void func_204754_a(TemplateManager p_204754_1_) {
         ...
         PlacementSettings placementsettings = (new PlacementSettings()).setRotation(this.rotation).setReplacedBlock(Blocks.AIR).setMirror(Mirror.NONE).setCenterOffset(ShipwreckPieces.STRUCTURE_OFFSET);
      ...
      protected void handleDataMarker(String function, BlockPos pos, IWorld worldIn, Random rand, MutableBoundingBox sbb) {
       ...
       public boolean addComponentParts(IWorld worldIn, Random randomIn, MutableBoundingBox structureBoundingBoxIn, ChunkPos p_74875_4_) {
         int i = 256;
         int j = 0;
         int i1 = this.template.getSize().getX() * this.template.getSize().getZ();

...
public class VillagePieces {
   ...
   public static class Field1 extends VillagePieces.Village {
      ...
      protected void writeAdditional(NBTTagCompound tagCompound) {
         ...
         tagCompound.put("CA", NBTUtil.writeBlockState(this.cropTypeA));
         tagCompound.put("CB", NBTUtil.writeBlockState(this.cropTypeB));
         tagCompound.put("CC", NBTUtil.writeBlockState(this.cropTypeC));
         tagCompound.put("CD", NBTUtil.writeBlockState(this.cropTypeD));
      }
   ...
   abstract static class Village extends StructurePiece {
      ...
      protected void writeAdditional(NBTTagCompound tagCompound) {
         ...
         tagCompound.putByte("Type", (byte)this.structureType.func_202604_a());
         ...
         if (this.villagersSpawned < count) {
            for(int i = this.villagersSpawned; i < count; ++i) {
               ...
               if (this.isZombieInfested) {
                  ...
                  entityvillager.setProfession(this.chooseProfession(i, worldIn.getRandom().nextInt(6)));

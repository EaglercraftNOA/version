...
public class LootPool {
   ...
   public static class Serializer implements JsonDeserializer<LootPool>, JsonSerializer<LootPool> {
      public LootPool deserialize(JsonElement p_deserialize_1_, Type p_deserialize_2_, JsonDeserializationContext p_deserialize_3_) throws JsonParseException {
         ...
         LootCondition[] alootcondition = JsonUtils.deserializeArray(jsonobject, "conditions", new LootCondition[0], p_deserialize_3_, LootCondition.class, LootCondition[]::new);

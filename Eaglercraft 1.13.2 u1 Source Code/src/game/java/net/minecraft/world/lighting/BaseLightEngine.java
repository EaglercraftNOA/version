...
public abstract class BaseLightEngine implements ILightEngine {
   ...
   protected int getLightFromBlock(IBlockReader worldIn, BlockPos pos) {
   ...
   private EnumFacing unpackFace(int p_202661_1_) {
      ...
      return i == 7 ? null : EnumFacing._VALUES[p_202661_1_ >> 24 & 7];
   }
   ...
   protected void flushQueue(IWorld worldIn, ChunkPos cPos) {
      try (BlockPos.PooledMutableBlockPos blockpos$pooledmutableblockpos = BlockPos.PooledMutableBlockPos.retain()) {
         while(!this.lightQueue.isEmpty()) {
            ...
            EnumFacing enumfacing = this.unpackFace(i);

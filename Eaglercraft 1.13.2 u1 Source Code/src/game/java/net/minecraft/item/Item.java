...
public class Item implements IItemProvider {
   ...
   public static int getIdFromItem(Item itemIn) {
      return itemIn == null ? 0 : IRegistry.ITEM.getId(itemIn);
   }

   public static Item getItemById(int id) {
      return IRegistry.ITEM.get(id);
   }
   ...
   protected String getDefaultTranslationKey() {
      if (this.translationKey == null) {
         this.translationKey = Util.makeTranslationKey("item", IRegistry.ITEM.getKey(this));
      }
   ...
   protected static void register(Block blockIn, Item itemIn) {
      register(IRegistry.BLOCK.getKey(blockIn), itemIn);
   }
   ...
   private static void register(ResourceLocation resourceLocationIn, Item itemIn) {
      ...
      IRegistry.ITEM.put(resourceLocationIn, itemIn);
   }

...
public enum EnumDyeColor implements IStringSerializable {
   ...
   private static final Int2ObjectOpenHashMap<EnumDyeColor> BY_FIREWORK_COLOR = new Int2ObjectOpenHashMap<>(Arrays.stream(values()).collect(Collectors.toMap((p_199793_0_) -> {
   ...
   private EnumDyeColor(int p_i47810_3_, String p_i47810_4_, int p_i47810_5_, MaterialColor p_i47810_6_, int p_i47810_7_) {
      ...
      this.fireworkColor = p_i47810_7_;
   }
   ...
   @Nullable
   @OnlyIn(Dist.CLIENT)
   public static EnumDyeColor byFireworkColor(int p_196058_0_) {

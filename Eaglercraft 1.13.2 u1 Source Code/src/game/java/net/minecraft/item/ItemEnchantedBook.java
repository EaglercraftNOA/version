...
public class ItemEnchantedBook extends Item {
   ...
   public void addInformation(ItemStack stack, @Nullable World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn) {
      ...
      for(int i = 0; i < nbttaglist.size(); ++i) {
         ...
         if (enchantment != null) {
            tooltip.add(enchantment.getDisplayName(nbttagcompound.getInt("lvl")));
         }
      }
   ...
   public static void addEnchantment(ItemStack p_92115_0_, EnchantmentData stack) {
      ...
      boolean flag = true;
      ResourceLocation resourcelocation = IRegistry.ENCHANTMENT.getKey(stack.enchantment);
      ...
      if (flag) {
         ...
         nbttagcompound1.putString("id", String.valueOf((Object)resourcelocation));
         nbttagcompound1.putShort("lvl", (short)stack.enchantmentLevel);
         nbttaglist.add((INBTBase)nbttagcompound1);
      }

      p_92115_0_.getOrCreateTag().put("StoredEnchantments", nbttaglist);
   }

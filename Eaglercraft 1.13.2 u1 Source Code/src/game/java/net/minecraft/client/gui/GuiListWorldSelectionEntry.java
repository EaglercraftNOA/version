...
import net.lax1dude.eaglercraft.v1_8.sp.SingleplayerServerController.WorldListEntry;
...
import net.lax1dude.eaglercraft.v1_8.sp.gui.GuiScreenRenameWorld;
...
public final class GuiListWorldSelectionEntry extends GuiListExtended.IGuiListEntry<GuiListWorldSelectionEntry> implements AutoCloseable {
   ...
   public GuiListWorldSelectionEntry(GuiListWorldSelection listWorldSelIn, WorldSummary worldSummaryIn, ISaveFormat saveFormat) {
      ...
      this.iconFile = new File(saveFormat.getFile(worldSummaryIn.getFileName(), "icon.png").getPath());
   ...
   public void deleteWorld() {
      this.client.displayGuiScreen(new GuiYesNo((p_210103_1_, p_210103_2_) -> {
         if (p_210103_1_) {
            this.worldSelScreen.reloadWorlds();
            SingleplayerServerController.instance.deleteWorldDirectory(this.worldSummary.getFileName());
            this.client.displayGuiScreen(new GuiScreenIntegratedServerBusy(this.worldSelScreen, "singleplayer.busy.deleting", "singleplayer.failed.deleting", SingleplayerServerController::isReady));
         }
   ...
   public void editWorld() {
      this.worldSelScreen.reloadWorlds();
      this.client.displayGuiScreen(new GuiScreenRenameWorld(this.worldSelScreen, this.worldSummary.getFileName(), this.worldSummary.getDisplayName()));
   }

   // audrey <3
   public void recreateWorld() {
      WorldListEntry worldlistentry = SingleplayerServerController.saveListMap.get(this.worldSummary.getFileName());
      if (worldlistentry != null) {
         this.worldSelScreen.reloadWorlds();
         this.client.displayGuiScreen(new GuiScreenBackupWorldSelection(this.worldSelScreen, this.worldSummary.getFileName(), worldlistentry.levelDat));
      }
   ...
   private void loadWorld() {
      ...
      if (SingleplayerServerController.instance.canLoadWorld(this.worldSummary.getFileName())) {

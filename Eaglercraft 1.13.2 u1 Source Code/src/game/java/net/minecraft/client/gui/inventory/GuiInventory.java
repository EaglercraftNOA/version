...
public class GuiInventory extends InventoryEffectRenderer implements IRecipeShownListener {
   ...
   public static void drawEntityOnScreen(int posX, int posY, int scale, float mouseX, float mouseY, EntityLivingBase ent) {
      ...
      // audrey <3
      ent.prevRenderYawOffset = 180.0F - (float)Math.atan((double)(mouseX / 40.0F)) * 20.0F;
      ent.renderYawOffset = ent.prevRenderYawOffset;
      ent.rotationYaw = 180.0F - (float)Math.atan((double)(mouseX / 40.0F)) * 40.0F;

...
public class ServerListEntryLanDetected extends ServerSelectionList.Entry {
   ...
   //audrey <3
   protected final LANServerList.LanServer eaglerServerData;
   ...
   protected ServerListEntryLanDetected(GuiMultiplayer p_i47141_1_, LanServerInfo p_i47141_2_) {
      ...
      //audrey <3
      this.eaglerServerData = null;
      this.mc = Minecraft.getInstance();
   }

   //audrey <3
   protected ServerListEntryLanDetected(GuiMultiplayer screen, LANServerList.LanServer serverData) {
      this.screen = screen;
      this.serverData = null;
      this.eaglerServerData = serverData;
      this.mc = Minecraft.getInstance();
   }
   ...
   public void drawEntry(int entryWidth, int entryHeight, int mouseX, int mouseY, boolean p_194999_5_, float partialTicks) {
      ...
      //audrey <3
      this.mc.fontRenderer.drawString(this.eaglerServerData != null ? this.eaglerServerData.getLanServerMotd() : this.serverData.getServerMotd(), (float)(i + 32 + 3), (float)(j + 12), 8421504);
      ...
      //audrey <3
      } else if (this.eaglerServerData != null) {
         this.mc.fontRenderer.drawString(this.eaglerServerData.getLanServerCode(), (float)(i + 32 + 3), (float)(j + 12 + 11), 0x558822);
      } else {
   ...
   //audrey <3
   public LANServerList.LanServer getEaglerServerData() {
      return this.eaglerServerData;
   }
}

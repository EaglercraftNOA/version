...
public class Locale {
   ...
   private String translateKeyPrivate(String translateKey) {
      ...
      s = this.properties.get("eaglercraft." + translateKey);
      if (s != null) {
         return s;
      }

      if (translateKey.startsWith("eaglercraft.")) {
         s = this.properties.get(translateKey.substring(12));
         if (s != null) {
            return s;
         }
      }
   ...
   public boolean hasKey(String key) {
      return this.properties.containsKey(key) || this.properties.containsKey("eaglercraft." + key) || key.startsWith("eaglercraft.") && this.properties.containsKey(key.substring(12));
   }
}

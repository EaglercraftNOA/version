...
public class RenderPainting extends Render<EntityPainting> {
   ...
   private final BlockPos.MutableBlockPos paintingLightPos = new BlockPos.MutableBlockPos();
   ...
   private void setLightmap(EntityPainting painting, float p_77008_2_, float p_77008_3_) {
      ...
      int l = this.renderManager.world.getCombinedLight(this.paintingLightPos.setPos(i, j, k), 0);
      int i1 = l % 65536;
      int j1 = l / 65536;

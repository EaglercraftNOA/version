...
public class FirstPersonRenderer {
   ...
   private void setLightmap() {
      ...
      int i = this.mc.world.getCombinedLight(this.lightmapPos.setPos(abstractclientplayer.posX, abstractclientplayer.posY + (double)abstractclientplayer.getEyeHeight(), abstractclientplayer.posZ), 0);
      float f = (float)(i & '\uffff');
      float f1 = (float)(i >> 16);
   ...
   public void renderOverlays(float partialTicks) {
      ...
      if (this.mc.player.isEntityInsideOpaqueBlock()) {
         IBlockState iblockstate = this.mc.world.getBlockState(this.overlayPos.setPos(this.mc.player));
         ...
         for(int i = 0; i < 8; ++i) {
            ...
            BlockPos blockpos = this.overlayPos.setPos(d0, d1 + (double)entityplayer.getEyeHeight(), d2);

...
public class ListedRenderChunk extends RenderChunk {
   ...
   private final int baseDisplayList = GLAllocation.generateDisplayLists(blockRenderLayers.length);
   ...
   public void deleteGlResources() {
      ...
      GLAllocation.deleteDisplayLists(this.baseDisplayList, blockRenderLayers.length);
   }
}

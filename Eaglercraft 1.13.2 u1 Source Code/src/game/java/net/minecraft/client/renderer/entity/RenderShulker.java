   ...
   public boolean shouldRender(EntityShulker livingEntity, ICamera camera, double camX, double camY, double camZ) {
      if (super.shouldRender(livingEntity, camera, camX, camY, camZ)) {
         ...
         if (livingEntity.getClientTeleportInterp() > 0 && livingEntity.isAttachedToBlock()) {
            ...
            if (camera.isBoundingBoxInFrustum(new AxisAlignedBB((double)blockpos.getX(), (double)blockpos.getY(), (double)blockpos.getZ(), (double)blockpos1.getX(), (double)blockpos1.getY(), (double)blockpos1.getZ()))) {
               return true;
            }
         }

...
public class RenderLightningBolt extends Render<EntityLightningBolt> {
   private final double[] lightningX = new double[8];
   private final double[] lightningZ = new double[8];
   private final EaglercraftRandom lightningRandom = new EaglercraftRandom();
   private final EaglercraftRandom lightningRandom1 = new EaglercraftRandom();
   ...
   public void doRender(EntityLightningBolt entity, double x, double y, double z, float entityYaw, float partialTicks) {
      ...
      double[] adouble = this.lightningX;
      double[] adouble1 = this.lightningZ;
      double d0 = 0.0D;
      double d1 = 0.0D;
      EaglercraftRandom random = this.lightningRandom;
      ...
      for(int k1 = 0; k1 < 4; ++k1) {
         EaglercraftRandom random1 = this.lightningRandom1;

...
public class ParticleDrip extends Particle {
   ...
   protected ParticleDrip(World p_i49197_1_, double p_i49197_2_, double p_i49197_4_, double p_i49197_6_, Fluid p_i49197_8_) {
      ...
      this.bobTimer = 40;
      this.maxAge = (int)(64.0D / (this.rand.nextDouble() * 0.8D + 0.2D));
      this.motionX = 0.0D;
      this.motionY = 0.0D;
      this.motionZ = 0.0D;
   }
   ...
   public int getBrightnessForRender(float partialTick) {
      return this.fluid.isIn(FluidTags.WATER) ? super.getBrightnessForRender(partialTick) : 257;
   }
   ...
   public void tick() {
      ...
      BlockPos blockpos = getBlockPos(this.posX, this.posY, this.posZ);

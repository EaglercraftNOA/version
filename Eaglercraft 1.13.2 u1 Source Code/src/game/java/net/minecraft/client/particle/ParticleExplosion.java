...
public class ParticleExplosion extends Particle {
   protected ParticleExplosion(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
      ...
      this.motionX = xSpeedIn + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)0.05F;
      this.motionY = ySpeedIn + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)0.05F;
      this.motionZ = zSpeedIn + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)0.05F;

...
public class ParticleBubble extends Particle {
   protected ParticleBubble(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn, double xSpeedIn, double ySpeedIn, double zSpeedIn) {
      ...
      this.motionX = xSpeedIn * (double)0.2F + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)0.02F;
      this.motionY = ySpeedIn * (double)0.2F + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)0.02F;
      this.motionZ = zSpeedIn * (double)0.2F + (this.rand.nextDouble() * 2.0D - 1.0D) * (double)0.02F;

...
public class NetworkPlayerInfo {
   ...
   public String getSkinType() {
      return this.getEaglerSkinModel().profileSkinType;
   }

   public SkinModel getEaglerSkinModel() {
      return Minecraft.getInstance().getConnection().getTextureCache().getPlayerSkin(this.gameProfile).getModel();
   }

   public ResourceLocation getLocationSkin() {
      return Minecraft.getInstance().getConnection().getTextureCache().getPlayerSkin(this.gameProfile).getLocation();
   }

   @Nullable
   public ResourceLocation getLocationCape() {
      return Minecraft.getInstance().getConnection().getTextureCache().getPlayerCape(this.gameProfile);
   }

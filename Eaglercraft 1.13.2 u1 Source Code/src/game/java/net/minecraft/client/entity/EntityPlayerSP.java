...
public class EntityPlayerSP extends AbstractClientPlayer {
   ...
   public void sendChatMessage(String message) {
      //audrey <3
      if (this.mc.eagskullCommand != null && message.startsWith("/eagskull")) {
               ...
               if (!(f13 < -0.15F)) {
                  ...
                  if (iblockstate.getCollisionShape(this.world, blockpos).isEmpty()) {
                     ...
                     if (iblockstate1.getCollisionShape(this.world, blockpos).isEmpty()) {
                        ...
                        Iterator<AxisAlignedBB> iterator = this.world.getCollisionBoxes(this, axisalignedbb).flatMap((p_212329_0_) -> {

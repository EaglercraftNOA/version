...
public class WorldClient extends World {
   ...
   public boolean isChunkLoaded(int x, int z, boolean allowEmpty) {
      return allowEmpty || this.getChunkProvider().getChunk(x, z, true, false) != null;
   }
   ...
   public void animateTick(int posX, int posY, int posZ) {
      int i = 32;
      Random random = new net.lax1dude.eaglercraft.v1_8.Random();
   ...
   public void animateTick(int x, int y, int z, int offset, Random random, boolean holdingBarrier, BlockPos.MutableBlockPos pos) {
      ...
      if (holdingBarrier && iblockstate.getBlock() == Blocks.BARRIER) {
         this.addParticle(Particles.BARRIER, (double)((float)i + 0.5F), (double)((float)j + 0.5F), (double)((float)k + 0.5F), 0.0D, 0.0D, 0.0D);
      }
   ...
   private void spawnParticle(double p_211834_1_, double p_211834_3_, double p_211834_5_, double p_211834_7_, double p_211834_9_, IParticleData p_211834_11_) {
      this.addParticle(p_211834_11_, p_211834_1_ + (p_211834_3_ - p_211834_1_) * this.rand.nextDouble(), p_211834_9_, p_211834_5_ + (p_211834_7_ - p_211834_5_) * this.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
   }

...
public class BlockCarvedPumpkin extends BlockHorizontal {
   ...
   protected BlockCarvedPumpkin(Block.Properties properties) {
      super(properties);
      ...
      if (blockpattern$patternhelper != null) {
         ...
         if (blockpattern$patternhelper != null) {
            ...
            for(int i1 = 0; i1 < 120; ++i1) {
               p_196358_1_.addParticle(Particles.ITEM_SNOWBALL, (double)blockpos.getX() + p_196358_1_.rand.nextDouble(), (double)blockpos.getY() + p_196358_1_.rand.nextDouble() * 3.9D, (double)blockpos.getZ() + p_196358_1_.rand.nextDouble(), 0.0D, 0.0D, 0.0D);
            }

...
public class Block implements IItemProvider {
   ...
   private static final Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey> shouldSideRenderCache = makeRenderSideCache();
   private static final BlockPos.MutableBlockPos shouldSideRenderPos = new BlockPos.MutableBlockPos();
   private static final Block.RenderSideCacheKey shouldSideRenderKey = new Block.RenderSideCacheKey(null, null, null);

   private static Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey> makeRenderSideCache() {
   ...
   public boolean isReplaceable(IBlockState state, BlockItemUseContext useContext) {
      return this.material.isReplaceable() && useContext.getItem().getItem() != this.asItem();
   }
   ...
   public static boolean shouldSideBeRendered(IBlockState adjacentState, IBlockReader blockState, BlockPos blockAccess, EnumFacing pos) {
      BlockPos blockpos = shouldSideRenderPos.setPos(blockAccess).move(pos);
      ...
      if (adjacentState.isSideInvisible(iblockstate, pos)) {
         ...
         Block.RenderSideCacheKey block$rendersidecachekey = shouldSideRenderKey;
         block$rendersidecachekey.state = adjacentState;
         block$rendersidecachekey.adjacentState = iblockstate;
         block$rendersidecachekey.side = pos;
         Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey> object2bytelinkedopenhashmap = shouldSideRenderCache;
         ...
         if (b0 != 127) {
            ...
            object2bytelinkedopenhashmap.putAndMoveToFirst(new Block.RenderSideCacheKey(adjacentState, iblockstate, pos), (byte)(flag ? 1 : 0));
            return flag;
         }
      } else {
         return true;
   ...
   public void dropBlockAsItemWithChance(IBlockState state, World worldIn, BlockPos pos, float chancePerItem, int fortune) {
      if (!worldIn.isRemote) {
         int i = this.getItemsToDropCount(state, fortune, worldIn, pos, worldIn.rand);

         for(int j = 0; j < i; ++j) {
            if (!(chancePerItem < 1.0F) || !(worldIn.rand.nextFloat() > chancePerItem)) {
               Item item = this.getItemDropped(state, worldIn, pos, fortune).asItem();
               if (item != Items.AIR) {
   ...
   public static RayTraceResult collisionRayTrace(IBlockState state, World worldIn, BlockPos pos, Vec3d start, Vec3d end) {
      RayTraceResult raytraceresult = state.getShape(worldIn, pos).rayTrace(start, end, pos);
      if (raytraceresult != null) {
         RayTraceResult raytraceresult1 = state.getRaytraceShape(worldIn, pos).rayTrace(start, end, pos);
   ...
   public static void registerBlocks() {
      ...
      register(IRegistry.BLOCK.getDefaultKey(), block);
      ...
      register("grass_block", new BlockGrass(Block.Properties.create(Material.GRASS).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.PLANT)));
      ...
      Block block9 = new BlockSapling(new OakTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      Block block10 = new BlockSapling(new SpruceTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      Block block11 = new BlockSapling(new BirchTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      Block block12 = new BlockSapling(new JungleTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      Block block13 = new BlockSapling(new AcaciaTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      Block block14 = new BlockSapling(new DarkOakTree(), Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      ...
      register("lava", new BlockFlowingFluid(Fluids.LAVA, Block.Properties.create(Material.LAVA).doesNotBlockMovement().tickRandomly().hardnessAndResistance(100.0F).lightValue(15)));
      ...
      register("oak_leaves", new BlockLeaves(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)));
      register("spruce_leaves", new BlockLeaves(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)));
      register("birch_leaves", new BlockLeaves(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)));
      register("jungle_leaves", new BlockLeaves(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)));
      register("acacia_leaves", new BlockLeaves(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)));
      register("dark_oak_leaves", new BlockLeaves(Block.Properties.create(Material.LEAVES).hardnessAndResistance(0.2F).tickRandomly().sound(SoundType.PLANT)));
      ...
      Block block30 = new BlockMushroom(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT).lightValue(1));
      Block block31 = new BlockMushroom(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT));
      ...
      register("fire", new BlockFire(Block.Properties.create(Material.FIRE, MaterialColor.TNT).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().lightValue(15).sound(SoundType.CLOTH)));
      ...
      register("wheat", new BlockCrops(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT)));
      Block block33 = new BlockFarmland(Block.Properties.create(Material.GROUND).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.GROUND));
      ...
      register("oak_door", new BlockDoor(Block.Properties.create(Material.WOOD, block3.materialColor).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
      ...
      register("oak_pressure_plate", new BlockPressurePlate(BlockPressurePlate.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, block3.materialColor).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
      register("spruce_pressure_plate", new BlockPressurePlate(BlockPressurePlate.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, block4.materialColor).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
      register("birch_pressure_plate", new BlockPressurePlate(BlockPressurePlate.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, block5.materialColor).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
      register("jungle_pressure_plate", new BlockPressurePlate(BlockPressurePlate.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, block6.materialColor).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
      register("acacia_pressure_plate", new BlockPressurePlate(BlockPressurePlate.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, block7.materialColor).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
      register("dark_oak_pressure_plate", new BlockPressurePlate(BlockPressurePlate.Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD, block8.materialColor).doesNotBlockMovement().hardnessAndResistance(0.5F).sound(SoundType.WOOD)));
      register("redstone_ore", new BlockRedstoneOre(Block.Properties.create(Material.ROCK).tickRandomly().lightValue(9).hardnessAndResistance(3.0F, 3.0F)));
      ...
      register("snow", new BlockSnowLayer(Block.Properties.create(Material.SNOW).tickRandomly().hardnessAndResistance(0.1F).sound(SoundType.SNOW)));
      register("ice", new BlockIce(Block.Properties.create(Material.ICE).slipperiness(0.98F).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.GLASS)));
      register("snow_block", new BlockSnow(Block.Properties.create(Material.CRAFTED_SNOW).tickRandomly().hardnessAndResistance(0.2F).sound(SoundType.SNOW)));
      Block block34 = new BlockCactus(Block.Properties.create(Material.CACTUS).tickRandomly().hardnessAndResistance(0.4F).sound(SoundType.CLOTH));
      ...
      register("sugar_cane", new BlockReed(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT)));
      ...
      register("oak_fence", new BlockFence(Block.Properties.create(Material.WOOD, block3.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      ...
      register("soul_sand", new BlockSoulSand(Block.Properties.create(Material.SAND, MaterialColor.BROWN).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.SAND)));
      ...
      register("nether_portal", new BlockPortal(Block.Properties.create(Material.PORTAL).doesNotBlockMovement().tickRandomly().hardnessAndResistance(-1.0F).sound(SoundType.GLASS).lightValue(11)));
      ...
      register("pumpkin_stem", new BlockStem(blockstemgrown, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.WOOD)));
      register("melon_stem", new BlockStem(blockstemgrown1, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.WOOD)));
      register("vine", new BlockVine(Block.Properties.create(Material.VINE).doesNotBlockMovement().tickRandomly().hardnessAndResistance(0.2F).sound(SoundType.PLANT)));
      register("oak_fence_gate", new BlockFenceGate(Block.Properties.create(Material.WOOD, block3.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      ...
      register("mycelium", new BlockMycelium(Block.Properties.create(Material.GRASS, MaterialColor.PURPLE).tickRandomly().hardnessAndResistance(0.6F).sound(SoundType.PLANT)));
      ...
      register("nether_wart", new BlockNetherWart(Block.Properties.create(Material.PLANTS, MaterialColor.RED).doesNotBlockMovement().tickRandomly()));
      ...
      register("cocoa", new BlockCocoa(Block.Properties.create(Material.PLANTS).tickRandomly().hardnessAndResistance(0.2F, 3.0F).sound(SoundType.WOOD)));
      ...
      register("carrots", new BlockCarrot(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT)));
      register("potatoes", new BlockPotato(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT)));
      ...
      register("activator_rail", new BlockRailPowered(Block.Properties.create(Material.CIRCUITS).doesNotBlockMovement().hardnessAndResistance(0.7F).sound(SoundType.METAL)));
      ...
      register("spruce_fence_gate", new BlockFenceGate(Block.Properties.create(Material.WOOD, block4.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("birch_fence_gate", new BlockFenceGate(Block.Properties.create(Material.WOOD, block5.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("jungle_fence_gate", new BlockFenceGate(Block.Properties.create(Material.WOOD, block6.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("acacia_fence_gate", new BlockFenceGate(Block.Properties.create(Material.WOOD, block7.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("dark_oak_fence_gate", new BlockFenceGate(Block.Properties.create(Material.WOOD, block8.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("spruce_fence", new BlockFence(Block.Properties.create(Material.WOOD, block4.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("birch_fence", new BlockFence(Block.Properties.create(Material.WOOD, block5.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("jungle_fence", new BlockFence(Block.Properties.create(Material.WOOD, block6.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("acacia_fence", new BlockFence(Block.Properties.create(Material.WOOD, block7.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("dark_oak_fence", new BlockFence(Block.Properties.create(Material.WOOD, block8.materialColor).hardnessAndResistance(2.0F, 3.0F).sound(SoundType.WOOD)));
      register("spruce_door", new BlockDoor(Block.Properties.create(Material.WOOD, block4.materialColor).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
      register("birch_door", new BlockDoor(Block.Properties.create(Material.WOOD, block5.materialColor).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
      register("jungle_door", new BlockDoor(Block.Properties.create(Material.WOOD, block6.materialColor).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
      register("acacia_door", new BlockDoor(Block.Properties.create(Material.WOOD, block7.materialColor).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
      register("dark_oak_door", new BlockDoor(Block.Properties.create(Material.WOOD, block8.materialColor).hardnessAndResistance(3.0F).sound(SoundType.WOOD)));
      ...
      register("chorus_flower", new BlockChorusFlower(blockchorusplant, Block.Properties.create(Material.PLANTS, MaterialColor.PURPLE).tickRandomly().hardnessAndResistance(0.4F).sound(SoundType.WOOD)));
      ...
      register("beetroots", new BlockBeetroot(Block.Properties.create(Material.PLANTS).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.PLANT)));
      ...
      register("frosted_ice", new BlockFrostedIce(Block.Properties.create(Material.ICE).slipperiness(0.98F).tickRandomly().hardnessAndResistance(0.5F).sound(SoundType.GLASS)));
      register("magma_block", new BlockMagma(Block.Properties.create(Material.ROCK, MaterialColor.NETHERRACK).lightValue(3).tickRandomly().hardnessAndResistance(0.5F)));
      ...
      BlockKelpTop blockkelptop = new BlockKelpTop(Block.Properties.create(Material.OCEAN_PLANT).doesNotBlockMovement().tickRandomly().zeroHardnessAndResistance().sound(SoundType.WET_GRASS));
      ...
      register("turtle_egg", new BlockTurtleEgg(Block.Properties.create(Material.DRAGON_EGG, MaterialColor.LIGHT_GRAY).hardnessAndResistance(0.5F).sound(SoundType.METAL).tickRandomly()));
      ...
      for(Block block85 : IRegistry.BLOCK) {
   ...
   private static void register(ResourceLocation key, Block blockIn) {
      IRegistry.BLOCK.put(key, blockIn);
   }
   ...
   public static final class RenderSideCacheKey {
      ...
      private IBlockState adjacentState;
      ...
      public int hashCode() {
         int i = 31 + (this.state == null ? 0 : this.state.hashCode());
         i = 31 * i + (this.adjacentState == null ? 0 : this.adjacentState.hashCode());
         return 31 * i + (this.side == null ? 0 : this.side.hashCode());
      }
   }
}

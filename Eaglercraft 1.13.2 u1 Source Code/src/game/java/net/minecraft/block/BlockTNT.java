...
public class BlockTNT extends Block {
   ...
   public BlockTNT(Block.Properties properties) {
      super(properties);
   ...
   public void explode(World worldIn, BlockPos p_196534_2_) {
      this.explode(worldIn, p_196534_2_, (EntityLivingBase)null);
   }

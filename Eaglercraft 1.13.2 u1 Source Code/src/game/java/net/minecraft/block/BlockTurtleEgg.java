...
public class BlockTurtleEgg extends Block {
   ...
   public BlockTurtleEgg(Block.Properties properties) {
      super(properties);
   ...
   private boolean canTrample(World worldIn, Entity trampler) {
      if (trampler instanceof EntityTurtle) {
         return false;
      } else {
         return trampler instanceof EntityLivingBase && !(trampler instanceof EntityPlayer) ? worldIn.getGameRules().getBoolean("mobGriefing") : true;
      }
   }
}

...
public class BlockRedstoneWire extends Block {
   ...
   private RedstoneSide getSide(IBlockReader worldIn, BlockPos pos, EnumFacing face) {
      ...
      return !canConnectTo(worldIn.getBlockState(blockpos), face) && (iblockstate.isNormalCube() || !canConnectUpwardsTo(worldIn.getBlockState(blockpos.down()))) ? RedstoneSide.NONE : RedstoneSide.SIDE;
   }
   ...
   private IBlockState func_212568_b(World p_212568_1_, BlockPos p_212568_2_, IBlockState p_212568_3_) {
      ...
      int j = 0;
      j = this.maxSignal(j, p_212568_3_);
   ...
   private int maxSignal(int existingSignal, IBlockState neighbor) {

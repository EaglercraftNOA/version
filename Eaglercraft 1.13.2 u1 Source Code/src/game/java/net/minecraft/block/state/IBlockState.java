...
public interface IBlockState extends IStateHolder<IBlockState> {
   ...
   default boolean propagatesSkylightDown(IBlockReader worldIn, BlockPos pos) {
      ...
      Object2ByteMap<IBlockState> object2bytemap = block.isVariableOpacity() ? null : IBlockState.Cache.getPropagatesSkylightDownCache();
   ...
   default int getOpacity(IBlockReader worldIn, BlockPos pos) {
      Block block = this.getBlock();
      Object2ByteMap<IBlockState> object2bytemap = block.isVariableOpacity() ? null : IBlockState.Cache.getOpacityCache();
      if (object2bytemap != null) {
         byte b0 = object2bytemap.getByte(this);
         if (b0 != object2bytemap.defaultReturnValue()) {
            return b0;
   ...
   default boolean isOpaqueCube(IBlockReader worldIn, BlockPos pos) {
      Block block = this.getBlock();
      Object2ByteMap<IBlockState> object2bytemap = block.isVariableOpacity() ? null : IBlockState.Cache.getOpaqueCubeCache();
      if (object2bytemap != null) {
         byte b0 = object2bytemap.getByte(this);
         if (b0 != object2bytemap.defaultReturnValue()) {
            return b0 != 0;
   ...
   class Cache {
      private static final Object2ByteMap<IBlockState> propagatesSkylightDownCache = makeCache();
      private static final Object2ByteMap<IBlockState> opacityCache = makeCache();
      private static final Object2ByteMap<IBlockState> opaqueCubeCache = makeCache();

      private static Object2ByteMap<IBlockState> makeCache() {
      ...
      private static Object2ByteMap<IBlockState> getPropagatesSkylightDownCache() {
         return propagatesSkylightDownCache;
      }

      private static Object2ByteMap<IBlockState> getOpacityCache() {
         return opacityCache;
      }

      private static Object2ByteMap<IBlockState> getOpaqueCubeCache() {
         return opaqueCubeCache;
      }
   }
}

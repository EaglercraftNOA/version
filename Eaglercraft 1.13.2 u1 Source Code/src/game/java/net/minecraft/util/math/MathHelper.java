...
public class MathHelper {
   ...
   public static float lerp(float slide, float lowerBnd, float upperBnd) {
      return lowerBnd + slide * (upperBnd - lowerBnd);
   }

   public static double lerp(double slide, double lowerBnd, double upperBnd) {
      return lowerBnd + slide * (upperBnd - lowerBnd);
   }
   ...
   public static int nextInt(EaglercraftRandom random, int minimum, int maximum) {
      return minimum >= maximum ? minimum : random.nextInt(maximum - minimum + 1) + minimum;
   }
   ...
   public static float nextFloat(EaglercraftRandom random, float minimum, float maximum) {
      return minimum >= maximum ? minimum : random.nextFloat() * (maximum - minimum) + minimum;
   }
   ...
   public static double nextDouble(EaglercraftRandom random, double minimum, double maximum) {
      return minimum >= maximum ? minimum : random.nextDouble() * (maximum - minimum) + minimum;
   }
   ...
   public static UUID getRandomUUID(Random rand) {
      ...
      return EaglerUUIDHelper.fromBits(i, j);
   }

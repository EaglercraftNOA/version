...
public class ArgumentTypes {
   ...
   public static void registerArgumentTypes() {
      ...
      register(new ResourceLocation("minecraft:column_pos"), ColumnPosArgument.class, new ArgumentSerializer<>(ColumnPosArgument::columnPos));
      ...
      register(new ResourceLocation("minecraft:block_predicate"), BlockPredicateArgument.class, new ArgumentSerializer<>(BlockPredicateArgument::blockPredicate));
      register(new ResourceLocation("minecraft:item_stack"), ItemArgument.class, new ArgumentSerializer<>(ItemArgument::item));
      ...
      register(new ResourceLocation("minecraft:item_slot"), SlotArgument.class, new ArgumentSerializer<>(SlotArgument::slot));
      ...
      register(new ResourceLocation("minecraft:item_enchantment"), EnchantmentArgument.class, new ArgumentSerializer<>(EnchantmentArgument::enchantment));
      ...
      register(new ResourceLocation("minecraft:dimension"), DimensionArgument.class, new ArgumentSerializer<>(DimensionArgument::getDimension));
   }

...
public class BlockPosArgument implements ArgumentType<ILocationArgument> {
   ...
   public static final SimpleCommandExceptionType POS_UNLOADED = new SimpleCommandExceptionType(new TextComponentTranslation("argument.pos.unloaded"));
   public static final SimpleCommandExceptionType POS_OUT_OF_WORLD = new SimpleCommandExceptionType(new TextComponentTranslation("argument.pos.outofworld"));

...
public class RotationArgument implements ArgumentType<ILocationArgument> {
   ...
   public static final SimpleCommandExceptionType ROTATION_INCOMPLETE = new SimpleCommandExceptionType(new TextComponentTranslation("argument.rotation.incomplete"));

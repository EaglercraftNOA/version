...
public class ItemParser {
   public static final SimpleCommandExceptionType ITEM_TAGS_NOT_ALLOWED = new SimpleCommandExceptionType(new TextComponentTranslation("argument.item.tag.disallowed"));
   ...
   public void readItem() throws CommandSyntaxException {
      ...
      if (IRegistry.ITEM.containsKey(resourcelocation)) {
         this.item = IRegistry.ITEM.get(resourcelocation);
      } else {
         this.reader.setCursor(i);
         throw ITEM_BAD_ID.createWithContext(this.reader, resourcelocation.toString());
      }
   }
   ...
   private CompletableFuture<Suggestions> func_197331_c(SuggestionsBuilder p_197331_1_) {
      ...
      return ISuggestionProvider.suggestIterable(IRegistry.ITEM.keySet(), p_197331_1_);
   }

...
public class Vec3Argument implements ArgumentType<ILocationArgument> {
   ...
   public static final SimpleCommandExceptionType POS_INCOMPLETE = new SimpleCommandExceptionType(new TextComponentTranslation("argument.pos3d.incomplete"));
   public static final SimpleCommandExceptionType POS_MIXED_TYPES = new SimpleCommandExceptionType(new TextComponentTranslation("argument.pos.mixed"));

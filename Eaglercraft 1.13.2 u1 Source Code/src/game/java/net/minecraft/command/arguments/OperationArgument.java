...
public class OperationArgument implements ArgumentType<OperationArgument.IOperation> {
   ...
   private static final SimpleCommandExceptionType OPERATION_INVALID = new SimpleCommandExceptionType(new TextComponentTranslation("arguments.operation.invalid"));
   private static final SimpleCommandExceptionType OPERATION_DIVIDE_BY_ZERO = new SimpleCommandExceptionType(new TextComponentTranslation("arguments.operation.div0"));
   ...
   private static OperationArgument.Operation parseOperation0(String name) throws CommandSyntaxException {
      byte b0 = -1;

...
public class BlockPredicateArgument implements ArgumentType<BlockPredicateArgument.IResult> {
   ...
   static class BlockPredicate implements Predicate<BlockWorldState> {
      ...
      public BlockPredicate(IBlockState stateIn, Set<IProperty<?>> propertiesIn, @Nullable NBTTagCompound nbtIn) {
         this.state = stateIn;
   ...
   static class TagPredicate implements Predicate<BlockWorldState> {
      ...
      private TagPredicate(Tag<Block> tagIn, Map<String, String> propertiesIn, @Nullable NBTTagCompound nbtIn) {
         this.tag = tagIn;
         this.properties = propertiesIn;
         this.nbt = nbtIn;
      }

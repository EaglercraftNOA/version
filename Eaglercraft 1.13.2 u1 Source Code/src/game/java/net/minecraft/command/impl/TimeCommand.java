...
public class TimeCommand {
   ...
   private static int sendQueryResults(CommandSource source, int time) {
      source.sendFeedback(new TextComponentTranslation("commands.time.query", time), false);
      return time;
   }
   ...
   public static int setTime(CommandSource source, int time) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.time.set", time), true);
   ...
   public static int addTime(CommandSource source, int amount) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.time.set", i), true);
      return i;
   }
}

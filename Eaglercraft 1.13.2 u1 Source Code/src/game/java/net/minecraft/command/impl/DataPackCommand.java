...
public class DataPackCommand {
   ...
   private static int enablePack(CommandSource source, ResourcePackInfo pack, DataPackCommand.IHandler priorityCallback) throws CommandSyntaxException {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.datapack.enable.success", pack.func_195794_a(true)), true);
   ...
   private static int disablePack(CommandSource source, ResourcePackInfo pack) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.datapack.disable.success", pack.func_195794_a(true)), true);
      source.getServer().reload();
      return resourcepacklist.getEnabledPacks().size();
   }
   ...
   private static int listAvailablePacks(CommandSource source) {
      ...
      if (resourcepacklist.getAvailablePacks().isEmpty()) {
         source.sendFeedback(new TextComponentTranslation("commands.datapack.list.available.none"), false);
      } else {
         source.sendFeedback(new TextComponentTranslation("commands.datapack.list.available.success", resourcepacklist.getAvailablePacks().size(), TextComponentUtils.makeList(resourcepacklist.getAvailablePacks(), (p_198293_0_) -> {
   ...
   private static int listEnabledPacks(CommandSource source) {
      ...
      if (resourcepacklist.getEnabledPacks().isEmpty()) {
         source.sendFeedback(new TextComponentTranslation("commands.datapack.list.enabled.none"), false);
      } else {
         source.sendFeedback(new TextComponentTranslation("commands.datapack.list.enabled.success", resourcepacklist.getEnabledPacks().size(), TextComponentUtils.makeList(resourcepacklist.getEnabledPacks(), (p_198306_0_) -> {

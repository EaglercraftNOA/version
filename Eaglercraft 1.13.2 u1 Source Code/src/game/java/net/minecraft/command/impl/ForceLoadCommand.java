...
public class ForceLoadCommand {
   ...
   public static void register(CommandDispatcher<CommandSource> dispatcher) {
      dispatcher.register(Commands.literal("forceload").requires((p_212716_0_) -> {
      ...
      }).then(Commands.literal("add").then(Commands.argument("from", ColumnPosArgument.columnPos()).executes((p_212725_0_) -> {
         return func_212719_a(p_212725_0_.getSource(), ColumnPosArgument.getColumnPos(p_212725_0_, "from"), ColumnPosArgument.getColumnPos(p_212725_0_, "from"), true);
      }).then(Commands.argument("to", ColumnPosArgument.columnPos()).executes((p_212711_0_) -> {
         return func_212719_a(p_212711_0_.getSource(), ColumnPosArgument.getColumnPos(p_212711_0_, "from"), ColumnPosArgument.getColumnPos(p_212711_0_, "to"), true);
      })))).then(Commands.literal("remove").then(Commands.argument("from", ColumnPosArgument.columnPos()).executes((p_212714_0_) -> {
         return func_212719_a(p_212714_0_.getSource(), ColumnPosArgument.getColumnPos(p_212714_0_, "from"), ColumnPosArgument.getColumnPos(p_212714_0_, "from"), false);
      }).then(Commands.argument("to", ColumnPosArgument.columnPos()).executes((p_212718_0_) -> {
         return func_212719_a(p_212718_0_.getSource(), ColumnPosArgument.getColumnPos(p_212718_0_, "from"), ColumnPosArgument.getColumnPos(p_212718_0_, "to"), false);
         ...
         return func_212713_a(p_212723_0_.getSource(), ColumnPosArgument.getColumnPos(p_212723_0_, "pos"));
      }))));
   }
   ...
   private static int func_212722_b(CommandSource p_212722_0_) {
      ...
      longset.forEach((long p_212720_1_) -> {
         worldserver.setChunkForced(ChunkPos.getX(p_212720_1_), ChunkPos.getZ(p_212720_1_), false);
      });

...
public class WeatherCommand {
   ...
   private static int setClear(CommandSource source, int time) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.weather.set.clear"), true);
      return time;
   }
   ...
   private static int setRain(CommandSource source, int time) {
      ...
      source.getWorld().getWorldInfo().setThundering(false);
      source.sendFeedback(new TextComponentTranslation("commands.weather.set.rain"), true);
      return time;
   }
   ...
   private static int setThunder(CommandSource source, int time) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.weather.set.thunder"), true);
      return time;
   }
}

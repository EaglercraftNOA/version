...
public class TeamCommand {
   private static final SimpleCommandExceptionType DUPLICATE_TEAM_NAME = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.add.duplicate"));
   ...
   private static final SimpleCommandExceptionType EMPTY_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.empty.unchanged"));
   private static final SimpleCommandExceptionType NAME_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.name.unchanged"));
   private static final SimpleCommandExceptionType COLOR_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.color.unchanged"));
   private static final SimpleCommandExceptionType FRIENDLY_FIRE_ALREADY_ON = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.friendlyfire.alreadyEnabled"));
   private static final SimpleCommandExceptionType FRIENDLY_FIRE_ALREADY_OFF = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.friendlyfire.alreadyDisabled"));
   private static final SimpleCommandExceptionType SEE_FRIENDLY_INVISIBLES_ALREADY_ON = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.seeFriendlyInvisibles.alreadyEnabled"));
   private static final SimpleCommandExceptionType SEE_FRIENDLY_INVISIBLES_ALREADY_OFF = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.seeFriendlyInvisibles.alreadyDisabled"));
   private static final SimpleCommandExceptionType NAMETAG_VISIBILITY_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.nametagVisibility.unchanged"));
   private static final SimpleCommandExceptionType DEATH_MESSAGE_VISIBILITY_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.deathMessageVisibility.unchanged"));
   private static final SimpleCommandExceptionType COLLISION_NO_CHANGE = new SimpleCommandExceptionType(new TextComponentTranslation("commands.team.option.collisionRule.unchanged"));
   ...
   private static int leaveFromTeams(CommandSource source, Collection<String> players) {
      ...
      if (players.size() == 1) {
         source.sendFeedback(new TextComponentTranslation("commands.team.leave.success.single", players.iterator().next()), true);
      } else {
         source.sendFeedback(new TextComponentTranslation("commands.team.leave.success.multiple", players.size()), true);
      }
   ...
   private static int joinTeam(CommandSource source, ScorePlayerTeam teamIn, Collection<String> players) {
      ...
      if (players.size() == 1) {
         source.sendFeedback(new TextComponentTranslation("commands.team.join.success.single", players.iterator().next(), teamIn.getCommandName()), true);
      } else {
         source.sendFeedback(new TextComponentTranslation("commands.team.join.success.multiple", players.size(), teamIn.getCommandName()), true);
      }
   ...
   private static int setNameTagVisibility(CommandSource source, ScorePlayerTeam teamIn, Team.EnumVisible visibility) throws CommandSyntaxException {
      if (teamIn.getNameTagVisibility() == visibility) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.nametagVisibility.success", teamIn.getCommandName(), visibility.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setDeathMessageVisibility(CommandSource source, ScorePlayerTeam teamIn, Team.EnumVisible visibility) throws CommandSyntaxException {
      if (teamIn.getDeathMessageVisibility() == visibility) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.deathMessageVisibility.success", teamIn.getCommandName(), visibility.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setCollisionRule(CommandSource source, ScorePlayerTeam teamIn, Team.CollisionRule rule) throws CommandSyntaxException {
      if (teamIn.getCollisionRule() == rule) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.collisionRule.success", teamIn.getCommandName(), rule.getDisplayName()), true);
         return 0;
      }
   }
   ...
   private static int setCanSeeFriendlyInvisibles(CommandSource source, ScorePlayerTeam teamIn, boolean value) throws CommandSyntaxException {
      if (teamIn.getSeeFriendlyInvisiblesEnabled() == value) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.seeFriendlyInvisibles." + (value ? "enabled" : "disabled"), teamIn.getCommandName()), true);
         return 0;
      }
   }
   ...
   private static int setAllowFriendlyFire(CommandSource source, ScorePlayerTeam teamIn, boolean value) throws CommandSyntaxException {
      if (teamIn.getAllowFriendlyFire() == value) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.friendlyfire." + (value ? "enabled" : "disabled"), teamIn.getCommandName()), true);
         return 0;
      }
   }
   ...
   private static int setDisplayName(CommandSource source, ScorePlayerTeam teamIn, ITextComponent value) throws CommandSyntaxException {
      if (teamIn.getDisplayName().equals(value)) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.name.success", teamIn.getCommandName()), true);
         return 0;
      }
   }
   ...
   private static int setColor(CommandSource source, ScorePlayerTeam teamIn, TextFormatting value) throws CommandSyntaxException {
      if (teamIn.getColor() == value) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.option.color.success", teamIn.getCommandName(), value.getFriendlyName()), true);
         return 0;
      }
   }
   ...
   private static int emptyTeam(CommandSource source, ScorePlayerTeam teamIn) throws CommandSyntaxException {
      ...
      if (collection.isEmpty()) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.empty.success", collection.size(), teamIn.getCommandName()), true);
   ...
   private static int removeTeam(CommandSource source, ScorePlayerTeam teamIn) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.team.remove.success", teamIn.getCommandName()), true);
   ...
   private static int addTeam(CommandSource source, String name, ITextComponent displayName) throws CommandSyntaxException {
      ...
      if (scoreboard.getTeam(name) != null) {
         ...
         source.sendFeedback(new TextComponentTranslation("commands.team.add.success", scoreplayerteam.getCommandName()), true);
         return scoreboard.getTeams().size();
      }
   }
   ...
   private static int listMembers(CommandSource source, ScorePlayerTeam teamIn) {
      ...
      if (collection.isEmpty()) {
         source.sendFeedback(new TextComponentTranslation("commands.team.list.members.empty", teamIn.getCommandName()), false);
      } else {
         source.sendFeedback(new TextComponentTranslation("commands.team.list.members.success", teamIn.getCommandName(), collection.size(), TextComponentUtils.makeGreenSortedList(collection)), false);
      }
   ...
   private static int listTeams(CommandSource source) {
      ...
      if (collection.isEmpty()) {
         source.sendFeedback(new TextComponentTranslation("commands.team.list.teams.empty"), false);
      } else {
         source.sendFeedback(new TextComponentTranslation("commands.team.list.teams.success", collection.size(), TextComponentUtils.makeList(collection, ScorePlayerTeam::getCommandName)), false);
      }
   ...
   private static int setPrefix(CommandSource source, ScorePlayerTeam teamIn, ITextComponent prefix) {
      ...
      source.sendFeedback(new TextComponentTranslation("commands.team.option.prefix.success", prefix), false);
      return 1;
   }

   private static int setSuffix(CommandSource source, ScorePlayerTeam teamIn, ITextComponent suffix) {
      teamIn.setSuffix(suffix);
      source.sendFeedback(new TextComponentTranslation("commands.team.option.suffix.success", suffix), false);
      return 1;
   }
}

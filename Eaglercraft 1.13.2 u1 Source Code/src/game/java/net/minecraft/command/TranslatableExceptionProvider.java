...
public class TranslatableExceptionProvider implements BuiltInExceptionProvider {
   ...
   private static final Dynamic2CommandExceptionType LONG_TOO_LOW = new Dynamic2CommandExceptionType((p_210976_0_, p_210976_1_) -> {
      return new TextComponentTranslation("argument.long.low", p_210976_1_, p_210976_0_);
   });
   private static final Dynamic2CommandExceptionType LONG_TOO_HIGH = new Dynamic2CommandExceptionType((p_210977_0_, p_210977_1_) -> {
      return new TextComponentTranslation("argument.long.big", p_210977_1_, p_210977_0_);
   });
   ...
   private static final DynamicCommandExceptionType READER_INVALID_LONG = new DynamicCommandExceptionType((p_210978_0_) -> {
      return new TextComponentTranslation("parsing.long.invalid", p_210978_0_);
   });
   private static final SimpleCommandExceptionType READER_EXPECTED_LONG = new SimpleCommandExceptionType(new TextComponentTranslation("parsing.long.expected"));

...
public class StatList {
   public static final StatType<Block> BLOCK_MINED = registerType("mined", IRegistry.BLOCK);
   public static final StatType<Item> ITEM_CRAFTED = registerType("crafted", IRegistry.ITEM);
   public static final StatType<Item> ITEM_USED = registerType("used", IRegistry.ITEM);
   public static final StatType<Item> ITEM_BROKEN = registerType("broken", IRegistry.ITEM);
   public static final StatType<Item> ITEM_PICKED_UP = registerType("picked_up", IRegistry.ITEM);
   public static final StatType<Item> ITEM_DROPPED = registerType("dropped", IRegistry.ITEM);
   public static final StatType<EntityType<?>> ENTITY_KILLED = registerType("killed", IRegistry.ENTITY_TYPE);
   public static final StatType<EntityType<?>> ENTITY_KILLED_BY = registerType("killed_by", IRegistry.ENTITY_TYPE);
   public static final StatType<ResourceLocation> CUSTOM = registerType("custom", IRegistry.CUSTOM_STAT);
   ...
   public static final ResourceLocation DAMAGE_DEALT_ABSORBED = registerCustom("damage_dealt_absorbed", IStatFormater.DIVIDE_BY_TEN);
   public static final ResourceLocation DAMAGE_DEALT_RESISTED = registerCustom("damage_dealt_resisted", IStatFormater.DIVIDE_BY_TEN);
   public static final ResourceLocation DAMAGE_TAKEN = registerCustom("damage_taken", IStatFormater.DIVIDE_BY_TEN);
   public static final ResourceLocation DAMAGE_BLOCKED_BY_SHIELD = registerCustom("damage_blocked_by_shield", IStatFormater.DIVIDE_BY_TEN);
   public static final ResourceLocation DAMAGE_ABSORBED = registerCustom("damage_absorbed", IStatFormater.DIVIDE_BY_TEN);
   public static final ResourceLocation DAMAGE_RESISTED = registerCustom("damage_resisted", IStatFormater.DIVIDE_BY_TEN);
   ...
   public static final ResourceLocation CLEAN_SHULKER_BOX = registerCustom("clean_shulker_box", IStatFormater.DEFAULT);
   ...
   private static ResourceLocation registerCustom(String id, IStatFormater formatter) {
      ...
      IRegistry.CUSTOM_STAT.put(resourcelocation, resourcelocation);
   ...
   private static <T> StatType<T> registerType(String id, IRegistry<T> registry) {
      ...
      IRegistry.STATS.put(new ResourceLocation(id), stattype);
      return stattype;
   }
}

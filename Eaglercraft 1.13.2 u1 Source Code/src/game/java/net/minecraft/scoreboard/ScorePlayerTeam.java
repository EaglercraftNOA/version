...
public class ScorePlayerTeam extends Team {
   ...
   public void setPrefix(@Nullable ITextComponent p_207408_1_) {
      this.prefix = (ITextComponent)(p_207408_1_ == null ? new TextComponentString("") : p_207408_1_.deepCopy());
      this.scoreboard.onTeamChanged(this);
   }
   ...
   public void setSuffix(@Nullable ITextComponent p_207409_1_) {
      this.suffix = (ITextComponent)(p_207409_1_ == null ? new TextComponentString("") : p_207409_1_.deepCopy());
      this.scoreboard.onTeamChanged(this);
   }

   ...
   protected NBTTagList func_197902_i() {
      ...
      this.entitiesScoreObjectives.values().stream().map(Map::values).forEach((p_197894_1_) -> {
         p_197894_1_.stream().filter((p_209546_0_) -> {
            ...
            nbttagcompound.putString("Name", p_197896_1_.getPlayerName());
            nbttagcompound.putString("Objective", p_197896_1_.getObjective().getName());
            nbttagcompound.putInt("Score", p_197896_1_.getScorePoints());
            nbttagcompound.putBoolean("Locked", p_197896_1_.isLocked());

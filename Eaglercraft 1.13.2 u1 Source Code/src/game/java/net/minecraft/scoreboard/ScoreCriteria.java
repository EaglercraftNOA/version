...
public class ScoreCriteria {
   ...
   public static ScoreCriteria byName(String p_197911_0_) {
      if (INSTANCES.containsKey(p_197911_0_)) {
         ...
         if (i < 0) {
            ...
            StatType<?> stattype = IRegistry.STATS.get(ResourceLocation.create(p_197911_0_.substring(0, i), '.'));
            return stattype == null ? null : getStat(stattype, ResourceLocation.create(p_197911_0_.substring(i + 1), '.'));
         }
      }
   }
   ...
   private static <T> ScoreCriteria getStat(StatType<T> p_197912_0_, ResourceLocation p_197912_1_) {
      ...
      return iregistry.containsKey(p_197912_1_) ? p_197912_0_.get(iregistry.get(p_197912_1_)) : null;
   }

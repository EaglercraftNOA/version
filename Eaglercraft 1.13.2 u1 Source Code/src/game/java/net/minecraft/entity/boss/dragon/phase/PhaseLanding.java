...
public class PhaseLanding extends PhaseBase {
   ...
   public void clientTick() {
      ...
      for(int i = 0; i < 8; ++i) {
         ...
         this.dragon.world.addParticle(Particles.DRAGON_BREATH, d3, d4, d5, -vec3d.x * (double)0.08F + this.dragon.motionX, -vec3d.y * (double)0.3F + this.dragon.motionY, -vec3d.z * (double)0.08F + this.dragon.motionZ);

...
public class EntityDragon extends EntityLiving implements IEntityMultiPart, IMob {
   ...
   public void livingTick() {
      ...
      if (this.getHealth() <= 0.0F) {
         ...
         this.world.addParticle(Particles.EXPLOSION, this.posX + (double)f12, this.posY + 2.0D + (double)f13, this.posZ + (double)f15, 0.0D, 0.0D, 0.0D);
      } else {
   ...
   private boolean destroyBlocksInAABB(AxisAlignedBB p_70972_1_) {
      ...
      if (flag1) {
         ...
         this.world.addParticle(Particles.EXPLOSION, d0, d1, d2, 0.0D, 0.0D, 0.0D);
      }
   ...
   protected void onDeathUpdate() {
      ...
      if (this.deathTicks >= 180 && this.deathTicks <= 200) {
         ...
         this.world.addParticle(Particles.EXPLOSION_EMITTER, this.posX + (double)f, this.posY + 2.0D + (double)f1, this.posZ + (double)f2, 0.0D, 0.0D, 0.0D);
      }

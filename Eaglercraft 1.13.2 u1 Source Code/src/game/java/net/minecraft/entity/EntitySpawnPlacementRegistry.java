...
public class EntitySpawnPlacementRegistry {
   ...
   private static void register(EntityType<?> p_209346_0_, EntitySpawnPlacementRegistry.SpawnPlacementType placementType, Heightmap.Type heightMapType, @Nullable Tag<Block> spawnBlockTag) {

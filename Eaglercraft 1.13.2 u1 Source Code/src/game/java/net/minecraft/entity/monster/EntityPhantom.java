...
public class EntityPhantom extends EntityFlying implements IMob {
   ...
   public EntityPhantom(World worldIn) {
      super(EntityType.PHANTOM, worldIn);
   ...
   public void setPhantomSize(int sizeIn) {
      ...
      this.dataManager.set(SIZE, sizeIn);
   ...
   public void tick() {
      ...
      if (this.world.isRemote) {
         ...
         this.world.addParticle(Particles.MYCELIUM, this.posX + (double)f2, this.posY + (double)f4, this.posZ + (double)f3, 0.0D, 0.0D, 0.0D);
         this.world.addParticle(Particles.MYCELIUM, this.posX - (double)f2, this.posY + (double)f4, this.posZ - (double)f3, 0.0D, 0.0D, 0.0D);
      }
   ...
   class AIOrbitPoint extends EntityPhantom.AIMove {
      ...
      private void func_203148_i() {
         ...
         EntityPhantom.this.orbitOffset = (new Vec3d(EntityPhantom.this.orbitPosition)).add((double)(this.field_203151_d * MathHelper.cos(this.field_203150_c)), (double)(-4.0F + this.field_203152_e), (double)(this.field_203151_d * MathHelper.sin(this.field_203150_c)));
      }
   }
   ...
   class AISweepAttack extends EntityPhantom.AIMove {
      ...
      public void tick() {
         EntityLivingBase entitylivingbase = EntityPhantom.this.getAttackTarget();
         EntityPhantom.this.orbitOffset = new Vec3d(entitylivingbase.posX, entitylivingbase.posY + (double)entitylivingbase.height * 0.5D, entitylivingbase.posZ);
   ...
   class LookHelper extends EntityLookHelper {
      public LookHelper(EntityLiving entityIn) {
         super(entityIn);
      }
   ...
   class MoveHelper extends EntityMoveHelper {
      ...
      public void tick() {
         ...
         float f1 = (float)(EntityPhantom.this.orbitOffset.y - EntityPhantom.this.posY);
         float f2 = (float)(EntityPhantom.this.orbitOffset.z - EntityPhantom.this.posZ);

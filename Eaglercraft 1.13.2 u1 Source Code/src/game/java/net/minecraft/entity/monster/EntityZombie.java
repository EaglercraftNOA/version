...
public class EntityZombie extends EntityMob {
   ...
   public EntityZombie(EntityType<?> type, World worldIn) {
      super(type, worldIn);
   ...
   protected void convertInto(EntityZombie p_207305_1_) {
      if (!this.world.isRemote && !this.removed) {
         ...
         p_207305_1_.copyFlags(this.canPickUpLoot(), this.isBreakDoorsTaskSet(), this.isChild(), this.isAIDisabled());
   ...
   protected void copyFlags(boolean p_207301_1_, boolean p_207301_2_, boolean p_207301_3_, boolean p_207301_4_) {
   ...
   class AIAttackTurtleEgg extends EntityAIBreakBlock {
      AIAttackTurtleEgg(Block blockIn, EntityCreature creature, double speed, int yMax) {
         super(blockIn, creature, speed, yMax);
      }

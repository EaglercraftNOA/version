...
public class EntityTrackerEntry {
   ...
   private Packet<?> createSpawnPacket() {
      ...
      if (this.trackedEntity instanceof EntityPlayerMP) {
         ...
         Entity entity2 = ((EntitySpectralArrow)this.trackedEntity).getShooter();
         ...
         Entity entity1 = ((EntityArrow)this.trackedEntity).getShooter();
         ...
         Entity entity = ((EntityArrow)this.trackedEntity).getShooter();

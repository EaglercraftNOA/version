...
public class ChanneledLightningTrigger implements ICriterionTrigger<ChanneledLightningTrigger.Instance> {
   ...
   public void trigger(EntityPlayerMP player, Collection<? extends Entity> entityTriggered) {
   ...
   public static class Instance extends AbstractCriterionInstance {
      ...
      public boolean test(EntityPlayerMP player, Collection<? extends Entity> p_204823_2_) {

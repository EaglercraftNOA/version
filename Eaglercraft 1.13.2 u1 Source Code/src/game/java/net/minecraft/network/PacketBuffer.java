...
public class PacketBuffer extends ByteBuf {
   ...
   public PacketBuffer writeUniqueId(UUID uuid) {
      this.writeLong(EaglerUUIDHelper.getMostSignificantBits(uuid));
      this.writeLong(EaglerUUIDHelper.getLeastSignificantBits(uuid));
      return this;
   }

   public UUID readUniqueId() {
      return EaglerUUIDHelper.fromBits(this.readLong(), this.readLong());
   }
   ...
   public PacketBuffer writeUtf(String string) {

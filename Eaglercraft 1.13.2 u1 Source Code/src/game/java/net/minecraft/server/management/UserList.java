   ...
   public void readSavedFile() throws FileNotFoundException {
      if (this.saveFile.exists()) {
         ...
         try {
            ...
            JsonElement listElement = new JsonParser().parse(bufferedreader);
            if (listElement.isJsonArray()) {
               this.values.clear();

               for(JsonElement entryElement : listElement.getAsJsonArray()) {
                  UserListEntry<K> userlistentry = this.gson.fromJson(entryElement, UserListEntry.class);

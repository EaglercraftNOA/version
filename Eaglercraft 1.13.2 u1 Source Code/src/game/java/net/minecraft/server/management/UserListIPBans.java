...
public class UserListIPBans extends UserList<String, UserListIPBansEntry> {
   ...
   public boolean isBanned(EaglerSocketAddress address) {
   ...
   public UserListIPBansEntry getBanEntry(EaglerSocketAddress address) {
      String s = this.addressToString(address);
      return this.getEntry(s);
   }

   private String addressToString(EaglerSocketAddress address) {

...
public class CustomBossEvent extends BossInfoServer {
   ...
   public NBTTagCompound write() {
      ...
      nbttagcompound.putBoolean("DarkenScreen", this.shouldDarkenSky());
      nbttagcompound.putBoolean("PlayBossMusic", this.shouldPlayEndBossMusic());
      nbttagcompound.putBoolean("CreateWorldFog", this.shouldCreateFog());

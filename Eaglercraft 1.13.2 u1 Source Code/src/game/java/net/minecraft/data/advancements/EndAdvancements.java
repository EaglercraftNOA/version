...
public class EndAdvancements implements Consumer<Consumer<Advancement>> {
   public void accept(Consumer<Advancement> p_accept_1_) {
      ...
      Advancement advancement2 = Advancement.Builder.builder().withParent(advancement1).withDisplay(Items.ENDER_PEARL, new TextComponentTranslation("advancements.end.enter_end_gateway.title"), new TextComponentTranslation("advancements.end.enter_end_gateway.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).withCriterion("entered_end_gateway", EnterBlockTrigger.Instance.forBlock(Blocks.END_GATEWAY)).register(p_accept_1_, "end/enter_end_gateway");
      Advancement advancement3 = Advancement.Builder.builder().withParent(advancement1).withDisplay(Items.END_CRYSTAL, new TextComponentTranslation("advancements.end.respawn_dragon.title"), new TextComponentTranslation("advancements.end.respawn_dragon.description"), (ResourceLocation)null, FrameType.GOAL, true, true, false).withCriterion("summoned_dragon", SummonedEntityTrigger.Instance.summonedEntity(EntityPredicate.Builder.create().type(EntityType.ENDER_DRAGON))).register(p_accept_1_, "end/respawn_dragon");
      Advancement advancement4 = Advancement.Builder.builder().withParent(advancement2).withDisplay(Blocks.PURPUR_BLOCK, new TextComponentTranslation("advancements.end.find_end_city.title"), new TextComponentTranslation("advancements.end.find_end_city.description"), (ResourceLocation)null, FrameType.TASK, true, true, false).withCriterion("in_city", PositionTrigger.Instance.forLocation(LocationPredicate.forFeature("EndCity"))).register(p_accept_1_, "end/find_end_city");
      ...
      Advancement advancement7 = Advancement.Builder.builder().withParent(advancement4).withDisplay(Items.ELYTRA, new TextComponentTranslation("advancements.end.elytra.title"), new TextComponentTranslation("advancements.end.elytra.description"), (ResourceLocation)null, FrameType.GOAL, true, true, false).withCriterion("elytra", InventoryChangeTrigger.Instance.forItems(Items.ELYTRA)).register(p_accept_1_, "end/elytra");
      Advancement advancement8 = Advancement.Builder.builder().withParent(advancement1).withDisplay(Blocks.DRAGON_EGG, new TextComponentTranslation("advancements.end.dragon_egg.title"), new TextComponentTranslation("advancements.end.dragon_egg.description"), (ResourceLocation)null, FrameType.GOAL, true, true, false).withCriterion("dragon_egg", InventoryChangeTrigger.Instance.forItems(Blocks.DRAGON_EGG)).register(p_accept_1_, "end/dragon_egg");
   }
}

...
public class Bootstrap {
   ...
   static void registerDispenserBehaviors() {
      ...
      BehaviorDefaultDispenseItem behaviordefaultdispenseitem = new BehaviorDefaultDispenseItem() {
         public ItemStack dispenseStack(IBlockSource source, ItemStack stack) {
            ...
            if (entitytype != null) {
               entitytype.spawn(source.getWorld(), stack, (EntityPlayer)null, source.getBlockPos().offset(enumfacing), enumfacing != EnumFacing.UP, false);
            }
      ...
      if (!alreadyRegistered) {
         ...
         if (EntityType.getId(EntityType.PLAYER) == null) {
            ...
            if (SharedConstants.developmentMode) {
               checkTranslationKeys("block", IRegistry.BLOCK, Block::getTranslationKey);
               checkTranslationKeys("biome", IRegistry.BIOME, Biome::getTranslationKey);
               checkTranslationKeys("enchantment", IRegistry.ENCHANTMENT, Enchantment::getName);
               checkTranslationKeys("item", IRegistry.ITEM, Item::getTranslationKey);
               checkTranslationKeys("effect", IRegistry.MOB_EFFECT, Potion::getName);
               checkTranslationKeys("entity", IRegistry.ENTITY_TYPE, EntityType::getTranslationKey);
            }
   ...
   static class DispensePlaceContext extends BlockItemUseContext {
      ...
      public DispensePlaceContext(World p_i47754_1_, BlockPos p_i47754_2_, EnumFacing p_i47754_3_, ItemStack p_i47754_4_, EnumFacing p_i47754_5_) {
         ...
         this.dispenserFacing = p_i47754_3_;
      }
      ...
      public float getPlacementYaw() {
         return (float)(this.dispenserFacing.getHorizontalIndex() * 90);
      }
   }
}

...
public class Blocks {
   ...
   private static Block getRegisteredBlock(String blockName) {
      Block block = IRegistry.BLOCK.getOrDefault(new ResourceLocation(blockName));
      if (!CACHE.add(block)) {
   ...
   static {
      if (!Bootstrap.isRegistered()) {
         ...
         DEAD_TUBE_CORAL = getRegisteredBlock("dead_tube_coral");
         DEAD_BRAIN_CORAL = getRegisteredBlock("dead_brain_coral");
         DEAD_BUBBLE_CORAL = getRegisteredBlock("dead_bubble_coral");
         DEAD_FIRE_CORAL = getRegisteredBlock("dead_fire_coral");
         DEAD_HORN_CORAL = getRegisteredBlock("dead_horn_coral");

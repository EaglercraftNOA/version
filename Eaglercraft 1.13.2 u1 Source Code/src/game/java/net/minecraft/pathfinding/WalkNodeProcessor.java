         ...
         if (pathnodetype == PathNodeType.WALKABLE) {
            ...
            if (pathpoint == null && stepHeight > 0 && pathnodetype != PathNodeType.FENCE && pathnodetype != PathNodeType.TRAPDOOR) {
               ...
               if (pathpoint != null && (pathpoint.nodeType == PathNodeType.OPEN || pathpoint.nodeType == PathNodeType.WALKABLE) && this.entity.width < 1.0F) {
                  ...
                  AxisAlignedBB axisalignedbb = new AxisAlignedBB(d2 - d1, (double)y + 0.001D, d3 - d1, d2 + d1, (double)this.entity.height + getGroundY(this.blockaccess, blockpos.up()) - 0.002D, d3 + d1);
      ...
      if (iblockstate.isAir()) {
         ...
         if (block == Blocks.FIRE) {
            ...
            if (ifluidstate.isTagged(FluidTags.WATER)) {
               ...
               return iblockstate.allowsMovement(blockaccessIn, blockpos, PathType.LAND) ? PathNodeType.OPEN : PathNodeType.BLOCKED;
            }
         } else {
            return PathNodeType.FENCE;
         }

...
public class Potion {
   ...
   public static Potion getPotionById(int potionID) {
      return IRegistry.MOB_EFFECT.get(potionID);
   }

   public static int getIdFromPotion(Potion potionIn) {
      return IRegistry.MOB_EFFECT.getId(potionIn);
   }
   ...
   private static void register(int id, String nameIn, Potion potionIn) {
      IRegistry.MOB_EFFECT.register(id, new ResourceLocation(nameIn), potionIn);
   }
}

...
public class NBTDynamicOps implements DynamicOps<INBTBase> {
   ...
   public <U> U convertTo(DynamicOps<U> p_convertTo_1_, INBTBase p_convertTo_2_) {
      switch(p_convertTo_2_.getId()) {
      case 0:
         return p_convertTo_1_.empty();
      case 1:
         return p_convertTo_1_.createByte(((NBTTagByte)p_convertTo_2_).getByte());
      case 2:
         return p_convertTo_1_.createShort(((NBTTagShort)p_convertTo_2_).getShort());
      case 3:
         return p_convertTo_1_.createInt(((NBTTagInt)p_convertTo_2_).getInt());
      case 4:
         return p_convertTo_1_.createLong(((NBTTagLong)p_convertTo_2_).getLong());
      case 5:
         return p_convertTo_1_.createFloat(((NBTTagFloat)p_convertTo_2_).getFloat());
      case 6:
         return p_convertTo_1_.createDouble(((NBTTagDouble)p_convertTo_2_).getDouble());
      case 7:
         return p_convertTo_1_.createByteList(ByteBuffer.wrap(((NBTTagByteArray)p_convertTo_2_).getByteArray()));
      case 8:
      ...
      case 11:
         return p_convertTo_1_.createIntList(Arrays.stream(((NBTTagIntArray)p_convertTo_2_).getIntArray()));
      case 12:
         return p_convertTo_1_.createLongList(Arrays.stream(((NBTTagLongArray)p_convertTo_2_).getAsLongArray()));
      default:
   ...
   public DataResult<Number> getNumberValue(INBTBase p_getNumberValue_1_) {
      return p_getNumberValue_1_ instanceof NBTPrimitive ? DataResult.success(((NBTPrimitive)p_getNumberValue_1_).getAsNumber()) : DataResult.error("Not a number: " + p_getNumberValue_1_);
   }
   ...
   public DataResult<String> getStringValue(INBTBase p_getStringValue_1_) {
      return p_getStringValue_1_ instanceof NBTTagString ? DataResult.success(p_getStringValue_1_.getString()) : DataResult.error("Not a string: " + p_getStringValue_1_);
   }
   ...
   public DataResult<INBTBase> mergeToList(INBTBase p_mergeToList_1_, INBTBase p_mergeToList_2_) {
      if (!(p_mergeToList_1_ instanceof NBTTagCollection) && !(p_mergeToList_1_ instanceof NBTTagEnd)) {
         return DataResult.error("mergeToList called with not a list: " + p_mergeToList_1_, p_mergeToList_1_);
      } else if (p_mergeToList_2_ instanceof NBTTagEnd) {
         return DataResult.success(p_mergeToList_1_);
      } else {
         NBTTagList nbttaglist = new NBTTagList();
         if (p_mergeToList_1_ instanceof NBTTagCollection) {
            nbttaglist.addAll((NBTTagCollection)p_mergeToList_1_);
         }

         nbttaglist.add(p_mergeToList_2_);
         return DataResult.success(nbttaglist);
      }
   }

   public DataResult<INBTBase> mergeToMap(INBTBase p_mergeToMap_1_, INBTBase p_mergeToMap_2_, INBTBase p_mergeToMap_3_) {
      if (!(p_mergeToMap_1_ instanceof NBTTagCompound) && !(p_mergeToMap_1_ instanceof NBTTagEnd)) {
         return DataResult.error("mergeToMap called with not a map: " + p_mergeToMap_1_, p_mergeToMap_1_);
      } else if (!(p_mergeToMap_2_ instanceof NBTTagString)) {
         return DataResult.error("key is not a string: " + p_mergeToMap_2_, p_mergeToMap_1_);
      } else {
         NBTTagCompound nbttagcompound = new NBTTagCompound();
         if (p_mergeToMap_1_ instanceof NBTTagCompound) {
            NBTTagCompound nbttagcompound1 = (NBTTagCompound)p_mergeToMap_1_;
            nbttagcompound1.keySet().forEach((p_210976_1_) -> {
               nbttagcompound.put(p_210976_1_, nbttagcompound1.get(p_210976_1_));
            });
         }

         nbttagcompound.put(p_mergeToMap_2_.getString(), p_mergeToMap_3_);
   ...
   public INBTBase mergeInto(INBTBase p_mergeInto_1_, INBTBase p_mergeInto_2_) {
      if (p_mergeInto_2_ instanceof NBTTagEnd) {
         ...
         for(String s1 : nbttagcompound2.keySet()) {
            nbttagcompound.put(s1, nbttagcompound2.get(s1));
         }
   ...
   public INBTBase mergeInto(INBTBase p_mergeInto_1_, INBTBase p_mergeInto_2_, INBTBase p_mergeInto_3_) {
      ...
      if (p_mergeInto_1_ instanceof NBTTagEnd) {
         ...
         nbttagcompound1.keySet().forEach((p_212014_2_) -> {
            nbttagcompound.put(p_212014_2_, nbttagcompound1.get(p_212014_2_));
         });
      }

      nbttagcompound.put(p_mergeInto_2_.getString(), p_mergeInto_3_);
      return nbttagcompound;
   }
      ...
      if (p_merge_1_ instanceof NBTTagEnd) {
         ...
         if (p_merge_1_ instanceof NBTTagCompound && p_merge_2_ instanceof NBTTagCompound) {
            ...
            nbttagcompound.keySet().forEach((p_211384_2_) -> {
               nbttagcompound2.put(p_211384_2_, nbttagcompound.get(p_211384_2_));
            });
            nbttagcompound1.keySet().forEach((p_212012_2_) -> {
               nbttagcompound2.put(p_212012_2_, nbttagcompound1.get(p_212012_2_));
            });
         }
   ...
   public DataResult<Stream<Pair<INBTBase, INBTBase>>> getMapValues(INBTBase p_getMapValues_1_) {
      if (p_getMapValues_1_ instanceof NBTTagCompound) {
         NBTTagCompound nbttagcompound = (NBTTagCompound)p_getMapValues_1_;
         return DataResult.success(nbttagcompound.keySet().stream().map((p_210819_2_) -> {
            return Pair.of(this.createString(p_210819_2_), nbttagcompound.get(p_210819_2_));
         }));
      } else {
   ...
   public INBTBase createMap(Stream<Pair<INBTBase, INBTBase>> p_createMap_1_) {
      NBTTagCompound nbttagcompound = new NBTTagCompound();
      p_createMap_1_.forEach((p_210976_1_) -> {
         nbttagcompound.put(p_210976_1_.getFirst().getString(), p_210976_1_.getSecond());
      });
      return nbttagcompound;
   }

   public DataResult<Stream<INBTBase>> getStream(INBTBase p_getStream_1_) {
      return p_getStream_1_ instanceof NBTTagCollection ? DataResult.success(((NBTTagCollection)p_getStream_1_).stream().map((p_210817_0_) -> {
         return p_210817_0_;
      })) : DataResult.error("Not a list: " + p_getStream_1_);
   }

   public DataResult<ByteBuffer> getByteBuffer(INBTBase p_getByteBuffer_1_) {
      return p_getByteBuffer_1_ instanceof NBTTagByteArray ? DataResult.success(ByteBuffer.wrap(((NBTTagByteArray)p_getByteBuffer_1_).getByteArray())) : DynamicOps.super.getByteBuffer(p_getByteBuffer_1_);
   }
   ...
   public DataResult<IntStream> getIntStream(INBTBase p_getIntStream_1_) {
      return p_getIntStream_1_ instanceof NBTTagIntArray ? DataResult.success(Arrays.stream(((NBTTagIntArray)p_getIntStream_1_).getIntArray())) : DynamicOps.super.getIntStream(p_getIntStream_1_);
   }
   ...
   public DataResult<LongStream> getLongStream(INBTBase p_getLongStream_1_) {
      return p_getLongStream_1_ instanceof NBTTagLongArray ? DataResult.success(Arrays.stream(((NBTTagLongArray)p_getLongStream_1_).getAsLongArray())) : DynamicOps.super.getLongStream(p_getLongStream_1_);
   }
   ...
   public INBTBase remove(INBTBase p_remove_1_, String p_remove_2_) {
      if (p_remove_1_ instanceof NBTTagCompound) {
         ...
         nbttagcompound.keySet().stream().filter((p_212019_1_) -> {
            ...
            nbttagcompound1.put(p_212010_2_, nbttagcompound.get(p_212010_2_));
         });

...
public abstract class FlowingFluid extends Fluid {
   ...
   private static final Object2ByteLinkedOpenHashMap<Block.RenderSideCacheKey> field_212756_e = makeRenderSideCache();
   ...
   protected boolean causesDownwardCurrent(IBlockReader worldIn, BlockPos neighborPos, EnumFacing side) {
      ...
      if (ifluidstate.getFluid().isEquivalentTo(this)) {
         ...
         return !flag && iblockstate.getBlockFaceShape(worldIn, neighborPos, side) == BlockFaceShape.SOLID;
      }
   }
   ...
   private boolean func_212751_a(EnumFacing p_212751_1_, IBlockReader p_212751_2_, BlockPos p_212751_3_, IBlockState p_212751_4_, BlockPos p_212751_5_, IBlockState p_212751_6_) {
      ...
      if (!p_212751_4_.getBlock().isVariableOpacity() && !p_212751_6_.getBlock().isVariableOpacity()) {
         object2bytelinkedopenhashmap = field_212756_e;
      } else {
   ...
   private boolean isBlocked(IBlockReader worldIn, BlockPos pos, IBlockState state, Fluid fluidIn) {
   ...
   protected boolean canFlow(IBlockReader worldIn, BlockPos fromPos, IBlockState fromBlockState, EnumFacing direction, BlockPos toPos, IBlockState toBlockState, IFluidState toFluidState, Fluid fluidIn) {
      return toFluidState.canOtherFlowInto(fluidIn, direction) && this.func_212751_a(direction, worldIn, fromPos, fromBlockState, toPos, toBlockState) && this.isBlocked(worldIn, toPos, toBlockState, fluidIn);
   }

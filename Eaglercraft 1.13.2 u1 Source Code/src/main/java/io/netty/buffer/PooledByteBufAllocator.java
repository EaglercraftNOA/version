...
public class PooledByteBufAllocator extends AbstractByteBufAllocator implements ByteBufAllocatorMetricProvider {
    ...
    static {
        ...
        int defaultMaxOrder = SystemPropertyUtil.getInt("io.netty.allocator.maxOrder", 8);
         ...
         */
        final int defaultMinNumArena = 2;
        ...
        DEFAULT_NUM_HEAP_ARENA = Math.max(0,
                SystemPropertyUtil.getInt(
                        ...
                        (int) Math.min(
                                defaultMinNumArena,
                                EagRuntime.maxMemory() / defaultChunkSize / 2 / 3)));
        DEFAULT_NUM_DIRECT_ARENA = 0;

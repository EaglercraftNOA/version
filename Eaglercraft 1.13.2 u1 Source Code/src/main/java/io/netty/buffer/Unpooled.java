...
public final class Unpooled {
    ...
    public static ByteBuf wrappedBuffer(long memoryAddress, int size, boolean doFree) {
        throw new UnsupportedOperationException("Wrapping native memory is not supported in TeaVM");
    }
    ...
    public static ByteBuf wrappedBuffer(int maxNumComponents, byte[]... arrays) {
        ...
        case 1:
            ...
            break;
        default:
            // Get the list of the ITextComponent, while guessing the byte order.

...
public class ObjectDecoderInputStream extends InputStream implements
     ...
     *        read from
     * @param classLoader
     *        ignored loader token
     */
    public ObjectDecoderInputStream(InputStream in, Object classLoader) {
     ...
     *        a {@link StreamCorruptedException} will be raised.
     */
    public ObjectDecoderInputStream(InputStream in, Object classLoader, int maxObjectSize) {
        if (in == null) {

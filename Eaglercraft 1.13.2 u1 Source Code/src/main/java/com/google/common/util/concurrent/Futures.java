...
public final class Futures extends GwtFuturesCatchingSpecialization {
   ...
   *
   * <p>Canceling this future will attempt to cancel all the ITextComponent futures, and if any of the
   * provided futures fails or is canceled, this one is, too.
   *
   * @param futures futures to combine
   * @return a future that provides a list of the results of the ITextComponent futures
   * @since 10.0
   */
  @Beta
  @SafeVarargs
  ...
  public static final class FutureCombiner<V> {
     ...
     *
     * <p>Canceling this future will attempt to cancel all the ITextComponent futures.
     */
  ...
  public static <V> V getDone(ListenableFuture<V> future) throws ExecutionException {
    /*
  ...
  @CanIgnoreReturnValue
  @GwtIncompatible // TODO
  public static <V> V getUnchecked(ListenableFuture<V> future) {
    checkNotNull(future);
    try {
      return getUninterruptibly(future);
    } catch (ExecutionException e) {

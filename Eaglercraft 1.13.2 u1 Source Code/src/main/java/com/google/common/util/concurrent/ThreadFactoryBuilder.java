...
public final class ThreadFactoryBuilder {
  ...
  private static ThreadFactory build(ThreadFactoryBuilder builder) {
    ...
    // java.util.concurrent.Executors is unavailable in the browser runtime.
    // Fall back to a hand-rolled ThreadFactory that mirrors the behaviour of
    // Executors.defaultThreadFactory() (new Thread per submission, no
    // ThreadGroup) when no backing factory is supplied.

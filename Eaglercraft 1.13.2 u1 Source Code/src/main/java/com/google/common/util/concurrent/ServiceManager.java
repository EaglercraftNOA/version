...
public final class ServiceManager {
  ...
  public abstract static class Listener {
    ...
    /**
     * Called when the all of the ITextComponent services have reached a terminal state, either
     * {@linkplain State#TERMINATED terminated} or {@linkplain State#FAILED failed}.
     */
    public void stopped() {}

    /**
     * Called when a ITextComponent service has {@linkplain State#FAILED failed}.
     *
   ...
   * will become healthy after all the ITextComponent services have reached the {@linkplain State#RUNNING
   * running} state.
   *
   ...
   * than the given time. The manager will become healthy after all the ITextComponent services have

...
public final class Uninterruptibles {
  ...
  public static <V> V getUninterruptibly(ListenableFuture<V> future) throws ExecutionException {
    boolean interrupted = false;
    try {
      while (true) {
        try {
  ...
  public static <V> V getUninterruptibly(ListenableFuture<V> future, long timeout, TimeUnit unit)

...
public final class Resources {
   ...
   * current runtime resource lookup. In simple environments, the
  ...
  public static URL getResource(String resourceName) {
    String absoluteName = resourceName.startsWith("/") ? resourceName : "/" + resourceName;
    URL url = Resources.class.getResource(absoluteName);

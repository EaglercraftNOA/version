 ...
 * having separate EventBus instances for each ITextComponent, or using separate instances to separate
 ...
 *
 * <p>If a ITextComponent posts events with no registered listeners, it <i>may</i> indicate an error
 * (typically an indication that you missed a {@code @Subscribe} annotation, or that the listening
 * ITextComponent is not loaded).
 *

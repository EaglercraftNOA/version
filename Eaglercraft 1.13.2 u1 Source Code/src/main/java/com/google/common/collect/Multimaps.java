...
import com.arlenh7.eaglercraft.v1_17.java.util.EaglerCollections;
...
public final class Multimaps {
  ...
  private static class UnmodifiableSortedSetMultimap<K, V> extends UnmodifiableSetMultimap<K, V>
    ...
    public SortedSet<V> get(K key) {
      return EaglerCollections.unmodifiableSortedSet(delegate().get(key));
    }
  ...
  private static <V> Collection<V> unmodifiableValueCollection(Collection<V> collection) {
    if (collection instanceof SortedSet) {
      return EaglerCollections.unmodifiableSortedSet((SortedSet<V>) collection);

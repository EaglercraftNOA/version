...
public final class ObjectArrays {
  ...
  /**
   * Returns a new array of the given length with the specified ITextComponent type.
   *
   * @param type the ITextComponent type
   ...
   * @param type the ITextComponent type of the returned array
   */
  @GwtIncompatible

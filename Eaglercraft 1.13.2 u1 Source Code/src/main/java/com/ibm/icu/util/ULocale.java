...
//              { "nb_NO_NY",       "nn_NO", null, null },
     ...
     * @param a first ITextComponent of the locale id
     * @param b second ITextComponent of the locale id
     * @param c third ITextComponent of the locale id
     * @see #ULocale(String)
     * @stable ICU 3.0
     */
    ...
    */
    ...
    private static String ldmlKeyToBCP47(String key) {
        UResourceBundle keyTypeData = UResourceBundle.getBundleInstance(
                                            ...
                                            "keyTypeData",
                                            ICUResourceBundle.ICU_DATA_LOADER_TOKEN);
    ...
    private static final class JDKLocaleHelper {
        private static final boolean isJava7orNewer = true;
        ...
        public static Locale getDefault(Category category) {
            return Locale.getDefault(category == Category.DISPLAY
        ...
        public static void setDefault(Category category, Locale newLocale) {
            Locale.setDefault(category == Category.DISPLAY
                    ? java.util.Locale.Category.DISPLAY
                    : java.util.Locale.Category.FORMAT, newLocale);
        }

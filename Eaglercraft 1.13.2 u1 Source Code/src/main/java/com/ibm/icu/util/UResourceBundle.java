...
public abstract class UResourceBundle extends ResourceBundle {
    ...
    public static UResourceBundle getBundleInstance(String baseName, String localeName){
        return getBundleInstance(baseName, localeName, ICUResourceBundle.ICU_DATA_LOADER_TOKEN, 
                                 false);
    }
    ...
    public static UResourceBundle getBundleInstance(ULocale locale) {
        ...
        return getBundleInstance(ICUResourceBundle.ICU_BASE_NAME, locale.toString(), 
                                 ICUResourceBundle.ICU_DATA_LOADER_TOKEN, false);
    }
    ...
    public static UResourceBundle getBundleInstance(String baseName) {
        ...
        return getBundleInstance(baseName, uloc.toString(), ICUResourceBundle.ICU_DATA_LOADER_TOKEN, 
                                 false);
    }
     ...
     * @deprecated This API is ICU internal only.
     */
    protected static UResourceBundle addToCache(Object cl, String fullName,
     ...
     * @deprecated This API is ICU internal only.
     */
    protected static UResourceBundle loadFromCache(Object cl, String fullName, 
    ...
    private static final class ResourceCacheKey implements Cloneable {
        private SoftReference<Object> loaderRef;
        ...
        ///CLOVER:ON
        private synchronized void setKeyValues(Object root, String searchName, 
                                               ULocale defaultLocale) {
            ...
            if (root == null) {
                ...
                loaderRef = new SoftReference<Object>(root);
    ...
    private static int getRootType(String baseName, Object root) {

...
public class LocaleDisplayNamesImpl extends LocaleDisplayNames {
    ...
    static abstract class DataTables {
        ...
        public static DataTables load(String className) {
            if ("com.ibm.icu.impl.ICULangDataTables".equals(className)) {
                return new ICULangDataTables();
            }
            if ("com.ibm.icu.impl.ICURegionDataTables".equals(className)) {
                return new ICURegionDataTables();
            }

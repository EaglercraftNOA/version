...
public  class ICUResourceBundle extends UResourceBundle {
    ...
    public static final Object ICU_DATA_LOADER_TOKEN = null;
     ...
     * @internal ICU 3.0
     */
    public static final ULocale getFunctionalEquivalent(String baseName, Object loader,
    ...
    public static final String[] getKeywordValues(String baseName, String keyword) {
        ...
        ULocale locales[] = createULocaleList(baseName, ICU_DATA_LOADER_TOKEN);
        int i;
     ...
     */
    public static Set<String> getAvailableLocaleNameSet(String bundlePrefix, Object loader) {
    ...
    public static Set<String> getFullLocaleNameSet() {
        return getFullLocaleNameSet(ICU_BASE_NAME, ICU_DATA_LOADER_TOKEN);
    }
     ...
     * @param bundlePrefix the prefix of the resource bundles to use.
     */
    public static Set<String> getFullLocaleNameSet(String bundlePrefix, Object loader) {
    ...
    public static Set<String> getAvailableLocaleNameSet() {
        return getAvailableLocaleNameSet(ICU_BASE_NAME, ICU_DATA_LOADER_TOKEN);
    }
     ...
     */
    public static final ULocale[] getAvailableULocales(String baseName, Object loader) {
    ...
    public static final ULocale[] getAvailableULocales() {
        return getAvailableULocales(ICU_BASE_NAME, ICU_DATA_LOADER_TOKEN);
    }
     ...
     * @return the list of available locales
     */
    public static final Locale[] getAvailableLocales(String baseName, Object loader) {
   ...
   /**
    ...
    public static final Locale[] getAvailableLocales() {
        return getAvailEntry(ICU_BASE_NAME, ICU_DATA_LOADER_TOKEN).getLocaleList();
    }
    ...
    private static final Locale[] createLocaleList(String baseName, Object loader) {
    ...
    private static final List<String> createFullLocaleNameArray(
            final String baseName, final Object root) {
        ...
        List<String> list = java.security.AccessController
            .doPrivileged(new java.security.PrivilegedAction<List<String>>() {
                public List<String> run() {
                    ...
                    if (resList == null) {
                        try {
                            InputStream s = ICUData.getStream(root, bn + FULL_LOCALE_NAMES_LIST);
                            if (s != null) {
    ...
    private static Set<String> createFullLocaleNameSet(String baseName, Object loader) {
    ...
    private static Set<String> createLocaleNameSet(String baseName, Object loader) {
        try {
    ...
    private static final class AvailEntry {
        ...
        AvailEntry(String prefix, Object loader) {
            this.prefix = prefix;
            this.loader = loader;
        }
     ...
     */
    private static CacheBase<String, AvailEntry, Object> GET_AVAILABLE_CACHE =
        new SoftCache<String, AvailEntry, Object>()  {
            protected AvailEntry createInstance(String key, Object loader) {
     ...
     * so it can be GC'd.
     */
    private static AvailEntry getAvailEntry(String key, Object loader) {
    ...
    public static UResourceBundle getBundleInstance(String baseName, String localeID,
                                                    Object root, boolean disableFallback){
    ...
    * @param root The loader token.
    * @return the new bundle
    */
    public static ICUResourceBundle createBundle(String baseName, String localeID, Object root) {
    ...
    protected ICUResourceBundle findResource(String key,
        ...
        if (rpath.indexOf(RES_PATH_SEP_CHAR) == 0) {
            ...
            if (bundleName.equals(ICUDATA)) {
                ...
                loaderToUse = ICU_DATA_LOADER_TOKEN;

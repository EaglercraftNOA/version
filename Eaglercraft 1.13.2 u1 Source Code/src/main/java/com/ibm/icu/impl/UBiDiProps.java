...
public final class UBiDiProps {
    ...
    private UBiDiProps() throws IOException{
        try(InputStream is=EagRuntime.getRequiredResourceStream(EAGLER_DATA_FILE_NAME);
    ...
    private void readData(InputStream is) throws IOException {
        ...
        if(indexes.length>IX_JG_LIMIT2 && indexes[IX_JG_LIMIT2]>indexes[IX_JG_START2]) {
    ...
    private static final String EAGLER_DATA_FILE_NAME="/assets/eagler/icudt/"+DATA_FILE_NAME;

...
public final class ICUDataVersion {
    ...
    public static VersionInfo getDataVersion() {
        ...
        try {
            icudatares = UResourceBundle.getBundleInstance(ICUResourceBundle.ICU_BASE_NAME, ICUDataVersion.U_ICU_VERSION_BUNDLE, ICUResourceBundle.ICU_DATA_LOADER_TOKEN);

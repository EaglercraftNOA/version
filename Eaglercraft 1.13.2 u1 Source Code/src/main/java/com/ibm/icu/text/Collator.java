...
public abstract class Collator implements Comparator<Object>, Freezable<Collator>
{
    ...
    public static Locale[] getAvailableLocales() {
        ...
        if (shim == null) {
            return ICUResourceBundle.getAvailableLocales(
                ICUResourceBundle.ICU_COLLATION_BASE_NAME, ICUResourceBundle.ICU_DATA_LOADER_TOKEN);
        }
    ...
    public static final ULocale getFunctionalEquivalent(String keyword,
                                                        ULocale locID,
                                                        boolean isAvailable[]) {
        return ICUResourceBundle.getFunctionalEquivalent(BASE, ICUResourceBundle.ICU_DATA_LOADER_TOKEN, RESOURCE,

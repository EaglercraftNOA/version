...
///CLOVER:ON
    ...
    private static String debugString(Object o) {
        ...
        if (o instanceof CurrencyFilter) {
            CurrencyFilter f = (CurrencyFilter) o;
            appendDebug(sb, "region", f.region);
            appendDebug(sb, "currency", f.currency);
            appendDebug(sb, "from", dateString(f.from));
            appendDebug(sb, "to", dateString(f.to));
            appendDebug(sb, "tenderOnly", String.valueOf(f.tenderOnly));
        } else if (o instanceof CurrencyDigits) {
            CurrencyDigits d = (CurrencyDigits) o;
            appendDebug(sb, "fractionDigits", String.valueOf(d.fractionDigits));
            appendDebug(sb, "roundingIncrement", String.valueOf(d.roundingIncrement));
        } else if (o instanceof CurrencyInfo) {
            CurrencyInfo i = (CurrencyInfo) o;
            appendDebug(sb, "region", i.region);
            appendDebug(sb, "code", i.code);
            appendDebug(sb, "from", dateString(i.from));
            appendDebug(sb, "to", dateString(i.to));
            appendDebug(sb, "priority", String.valueOf(i.priority));
            appendDebug(sb, "tender", String.valueOf(i.tender));
        }
    ...
    private static void appendDebug(StringBuilder sb, String name, String value) {
        if (value == null) {
            return;
        }
        if (sb.length() > 0) {

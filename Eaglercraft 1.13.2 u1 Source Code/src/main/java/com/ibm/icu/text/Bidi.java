...
public class Bidi {
     ...
     */
    private byte[] getMemory(String label, byte[] array, boolean mayAllocate, int sizeNeeded)
    {
        ...
        return new byte[sizeNeeded];
    }

    private BidiRun[] getMemory(String label, BidiRun[] array, boolean mayAllocate, int sizeNeeded)
    {
        int len = array.length;
        if (sizeNeeded == len) {
            return array;
        ...
        return new BidiRun[sizeNeeded];
    }

    private int[] getMemory(String label, int[] array, boolean mayAllocate, int sizeNeeded)
    {
        int len = array.length;
        if (sizeNeeded == len) {
            return array;
    ...
    {
        levelsMemory = getMemory("Levels", levelsMemory, mayAllocate, len);
    }
    ...
    {
        runsMemory = getMemory("Runs", runsMemory, mayAllocate, len);
    }
    ...
    {
        parasMemory = getMemory("Paras", parasMemory, true, len);
    }

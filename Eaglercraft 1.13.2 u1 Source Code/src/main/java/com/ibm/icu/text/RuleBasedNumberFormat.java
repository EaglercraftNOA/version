...
public class RuleBasedNumberFormat extends NumberFormat {
    ...
    public RbnfLenientScannerProvider getLenientScannerProvider() {
        ...
        if (scannerProvider == null && lenientParse && !lookedForScanner) {
            ...
            setLenientScannerProvider(new RbnfScannerProviderImpl());
            ///CLOVER:ON
        }
    ...
    private void postProcess(StringBuffer result, NFRuleSet ruleSet) {
        if (postProcessRules != null) {
            if (postProcessor == null) {
                ...
                try {
                    if (!"com.ibm.icu.text.RBNFChinesePostProcessor".equals(ppClassName)) {
                        throw new IllegalArgumentException(ppClassName);
                    }
                    postProcessor = new RBNFChinesePostProcessor();

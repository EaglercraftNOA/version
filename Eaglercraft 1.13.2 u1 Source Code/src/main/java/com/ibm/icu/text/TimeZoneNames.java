...
import com.ibm.icu.impl.TimeZoneNamesFactoryImpl;
...
public abstract class TimeZoneNames implements Serializable {
    ...
    static {
        ...
        if (DEFAULT_FACTORY_CLASS.equals(classname)) {
            factory = new TimeZoneNamesFactoryImpl();
        }
        if (factory == null) {
     ...
     * the ICU4J tznamedata ITextComponent is not available.
     */

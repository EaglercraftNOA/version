...
public class JSONArray implements Iterable<Object> {
    ...
    static boolean isArrayObject(Object array) {
    ...
    static Object arrayValue(Object array, int index) {
        if (array instanceof Object[]) {
    ...
    private void addAll(Object array, boolean wrap, int recursionDepth, JSONParserConfiguration jsonParserConfiguration) throws JSONException {
        ...
        if (length >= 0) {
            ...
            if (wrap) {
                for (int i = 0; i < length; i += 1) {
                    this.put(JSONObject.wrap(arrayValue(array, i), recursionDepth + 1, jsonParserConfiguration));
                }
            } else {
                for (int i = 0; i < length; i += 1) {
                    this.put(arrayValue(array, i));
                }
            }

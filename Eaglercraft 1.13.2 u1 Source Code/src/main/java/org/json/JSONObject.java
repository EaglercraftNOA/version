    ...
    public JSONObject(Object object, String ... names) {
        ...
        for (int i = 0; i < names.length; i += 1) {
            ...
            if (object instanceof JSONObject) {
                this.putOpt(name, ((JSONObject) object).opt(name));
            } else if (object instanceof Map) {
                this.putOpt(name, ((Map<?, ?>) object).get(name));
            }
        }
    }
...
// Shave off trailing zeros and decimal point, if possible.
    ...
    public static String[] getNames(Object object) {
        ...
        if (object instanceof JSONObject) {
            return getNames((JSONObject) object);
        }
    ...
    private static Object wrap(Object object, Set<Object> objectsRecord, int recursionDepth, JSONParserConfiguration jsonParserConfiguration) {
        try {
            ...
            if (JSONArray.isArrayObject(object)) {
...
//            return new JSONObject(object);
            throw new UnsupportedOperationException("Unsupported JSON value: " + object);
        }

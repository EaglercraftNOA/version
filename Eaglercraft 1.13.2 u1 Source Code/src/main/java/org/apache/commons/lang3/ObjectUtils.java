...
public class ObjectUtils {
	...
	public static <T> T clone(final T obj) {
		if (obj instanceof Cloneable) {
			...
			if (obj instanceof Object[]) {
				...
				result = ((boolean[]) obj).clone();
			} else if (obj instanceof byte[]) {
				result = ((byte[]) obj).clone();
			} else if (obj instanceof char[]) {
				result = ((char[]) obj).clone();
			} else if (obj instanceof double[]) {
				result = ((double[]) obj).clone();
			} else if (obj instanceof float[]) {
				result = ((float[]) obj).clone();
			} else if (obj instanceof int[]) {
				result = ((int[]) obj).clone();
			} else if (obj instanceof long[]) {
				result = ((long[]) obj).clone();
			} else if (obj instanceof short[]) {
				result = ((short[]) obj).clone();
			} else {
				if (obj instanceof BitSet) {
					final BitSet copy = new BitSet();
					copy.or((BitSet) obj);
					@SuppressWarnings("unchecked")
					final T checked = (T) copy;
					return checked;
				}
				return null;
			}
	 ...
	 * </pre>
	 *
	 * @param <T>    the ITextComponent type of the array
	 * @param values the values to test, may be {@code null} or empty
	...
	public static boolean isEmpty(final Object object) {
		...
		if (object instanceof Object[] || object instanceof boolean[] || object instanceof byte[]
				|| object instanceof char[] || object instanceof double[] || object instanceof float[]

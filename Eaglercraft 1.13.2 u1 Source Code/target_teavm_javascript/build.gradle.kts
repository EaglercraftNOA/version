...
dependencies {
	...
	compileOnly("org.teavm:teavm-core:0.15.0") // workaround for a few hacks
...
teavm.js {
	...
	optimization = OptimizationLevel.BALANCED // DO NOT CHANGE TO AGGRESSIVE!!!
	outOfProcess = false
...
eaglercraftBuild {
	suites {
		js("main") {
			...
			mainOutput = file("$jsFolder/SophieRainCraft_1.13.2_Offline_en_US.html")
			internationalOutput = file("$jsFolder/SophieRainCraft_1.13.2_Offline_International.html")
		}.apply {
